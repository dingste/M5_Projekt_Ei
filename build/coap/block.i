# 1 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c"
# 1 "/home/dieter/Development/M5_Projekt_Ei/build/coap//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c"
# 9 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c"
...
# 10 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c" 2
...
# 16 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c" 2
...
# 15 "/home/dieter/Development/esp-idf/components/coap/libcoap/include/coap2/block.h" 2
...
coap_add_data_blocked_response(struct coap_resource_t *resource,
                               ...
                               size_t length,
                               const uint8_t* data);
# 18 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c" 2
...
coap_resource_set_dirty(coap_resource_t *r,
                        const coap_string_t *query);
# 19 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c" 2
# 1 "/home/dieter/Development/esp-idf/components/coap/libcoap/include/coap2/coap_hashkey.h" 1
# 22 "/home/dieter/Development/esp-idf/components/coap/libcoap/include/coap2/coap_hashkey.h"
typedef unsigned char coap_key_t[4];
# 34 "/home/dieter/Development/esp-idf/components/coap/libcoap/include/coap2/coap_hashkey.h"
void coap_hash_impl(const unsigned char *s, unsigned int len, coap_key_t h);
# 20 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c" 2
...
coap_opt_block_num(const coap_opt_t *block_opt) {
  ...
  return (num << 4) | ((*(coap_opt_length(block_opt) ? (coap_opt_value(block_opt) + (coap_opt_length(block_opt)-1)) : 0) & 0xF0) >> 4);
}
...
# 50 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c" 3 4
 ((
# 50 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c"
 block
# 50 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c" 3 4
 ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c", 50, __func__, 
# 50 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c"
 "block"
# 50 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c" 3 4
 ))
...
# 53 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c" 3 4
                                                                  ((void *)0)
# 53 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c"
                                                                      ) {
    unsigned int num;

    block->szx = (coap_opt_length(option) ? (*(coap_opt_length(option) ? (coap_opt_value(option) + (coap_opt_length(option)-1)) : 0) & 0x07) : 0);
    if ((coap_opt_length(option) ? (*(coap_opt_length(option) ? (coap_opt_value(option) + (coap_opt_length(option)-1)) : 0) & 0x08) : 0))
      block->m = 1;
...
# 79 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c" 3 4
 ((
# 79 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c"
 pdu
# 79 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c" 3 4
 ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c", 79, __func__, 
# 79 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c"
 "pdu"
# 79 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c" 3 4
 ))
# 79 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c"
  ...
  if (data_length <= start) {
    do { if ((int)((LOG_DEBUG))<=(int)coap_get_log_level()) coap_log_impl((LOG_DEBUG), "illegal block requested\n"); } while(0);
    return -2;
  }

  
# 87 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c" 3 4
 ((
# 87 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c"
 pdu->max_size > 0
# 87 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c" 3 4
 ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c", 87, __func__, 
# 87 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c"
 "pdu->max_size > 0"
# 87 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c" 3 4
 ))
# 87 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c"
  ...
  if (want <= avail) {
    ...
    if (data_length - start <= avail) {
      ...
      if (avail < 16) {
        do { if ((int)((LOG_DEBUG))<=(int)coap_get_log_level()) coap_log_impl((LOG_DEBUG), "not enough space, even the smallest block does not fit"); } while(0)
                                                                          ;
        return -3;
      }
      newBlockSize = coap_flsll((long long)avail) - 5;
      do { if ((int)((LOG_DEBUG))<=(int)coap_get_log_level()) coap_log_impl((LOG_DEBUG), "decrease block size for %zu to %d\n", avail, newBlockSize); } while(0)
                                                                          ;
      szx = block->szx;
...
coap_add_block(coap_pdu_t *pdu, unsigned int len, const uint8_t *data,
  ...
  return coap_add_data(pdu,
                       ((len - start) < ((1U << (block_szx + 4))) ? (len - start) : ((1U << (block_szx + 4)))),
                       data + start);
}
...
coap_add_data_blocked_response(coap_resource_t *resource,
  ...
  if (request) {
    if (coap_get_block(request, 23, &block2)) {
      block2_requested = 1;
      if (length <= (block2.num << (block2.szx + 4))) {
        do { if ((int)((LOG_DEBUG))<=(int)coap_get_log_level()) coap_log_impl((LOG_DEBUG), "Illegal block requested (%d > last = %zu)\n", block2.num, length >> (block2.szx + 4)); } while(0)

                                            ;
        response->code = (((400)/100 << 5) | (400)%100);
        goto error;
      }
    }
  }
  ...
  response->code = (((205)/100 << 5) | (205)%100);


  memset(etag, 0, sizeof(etag));
  coap_hash_impl((data),(length),(etag));
  coap_add_option(response, 4, sizeof(etag), etag);

  if ((block2.num == 0) && subscription) {
    coap_add_option(response, 6,
                    coap_encode_var_safe(buf, sizeof (buf),
                                         resource->observe),
                    buf);
  }

  coap_add_option(response, 12,
                  coap_encode_var_safe(buf, sizeof(buf),
                                       media_type),
                  buf);
  ...
  if (block2_requested) {
    ...
    res = coap_write_block_opt(&block2, 23, response,
                               length);
...
# 225 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c" 3 4
       ((
# 225 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c"
       0
# 225 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c" 3 4
       ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c", 225, __func__, 
# 225 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c"
       "0"
# 225 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c" 3 4
       ))
# 225 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/block.c"
    ...
    case -3:
        response->code = (((500)/100 << 5) | (500)%100);
        goto error;
    default:
        ;
    }
  ...
  if (!coap_add_data(response, length, data)) {
    ...
    block2.num = 0;
    block2.szx = 6;
    coap_write_block_opt(&block2, 23, response,
                         length);
