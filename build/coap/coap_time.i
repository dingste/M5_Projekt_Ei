# 1 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/coap_time.c"
# 1 "/home/dieter/Development/M5_Projekt_Ei/build/coap//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/coap_time.c"
# 9 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/coap_time.c"
...
# 10 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/coap_time.c" 2
# 24 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/coap_time.c"
...
# 25 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/coap_time.c" 2
...
# 26 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/coap_time.c" 2

static coap_tick_t coap_clock_offset = 0;
# 57 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/coap_time.c"
void
coap_clock_init(void) {

  struct timespec tv;
  clock_gettime(
# 61 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/coap_time.c" 3 4
               (clockid_t)1
# 61 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/coap_time.c"
                         , &tv);
...
# 79 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/coap_time.c"
void
coap_ticks(coap_tick_t *t) {
  ...
  struct timespec tv;
  clock_gettime(
# 85 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/coap_time.c" 3 4
               (clockid_t)1
# 85 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/coap_time.c"
                         , &tv);
  ...
  tmp = (((coap_tick_t)((tv.tv_nsec * ((1 << (10)) * ((((coap_tick_t)(1000U))/1000000000.0)))) + (1 << ((10) - 1)))) >> (10));
# 109 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/coap_time.c"
  *t = tmp + (tv.tv_sec - coap_clock_offset) * ((coap_tick_t)(1000U));
}

coap_time_t
coap_ticks_to_rt(coap_tick_t t) {
  return coap_clock_offset + (t / ((coap_tick_t)(1000U)));
}

uint64_t coap_ticks_to_rt_us(coap_tick_t t) {
  return (uint64_t)coap_clock_offset * 1000000 + (uint64_t)t * 1000000 / ((coap_tick_t)(1000U));
}

coap_tick_t coap_ticks_from_rt_us(uint64_t t) {
  return (coap_tick_t)((t - (uint64_t)coap_clock_offset * 1000000) * ((coap_tick_t)(1000U)) / 1000000);
}
