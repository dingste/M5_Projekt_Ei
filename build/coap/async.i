# 1 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/async.c"
# 1 "/home/dieter/Development/M5_Projekt_Ei/build/coap//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/async.c"
# 16 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/async.c"
...
# 17 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/async.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/async.c" 2



# 1 "/home/dieter/Development/esp-idf/components/coap/libcoap/include/coap2/utlist.h" 1
# 22 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/async.c" 2
# 34 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/async.c"
coap_async_state_t *
coap_register_async(coap_context_t *context, coap_session_t *session,
  ...
  do { for ((s) = (context->async_state); s; (s) = (s)->next) { if ((s)->session == (session) && (s)->id == (id)) break; } } while(0);

  if (s != 
# 42 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/async.c" 3 4
          ((void *)0)
# 42 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/async.c"
              ) {


    do { if ((int)((LOG_DEBUG))<=(int)coap_get_log_level()) coap_log_impl((LOG_DEBUG), "asynchronous state for transaction %d already registered\n", id); } while(0)
                                                                          ;
    return 
# 47 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/async.c" 3 4
          ((void *)0)
# 47 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/async.c"
              ;
  }
  ...
  if (!s) {
    do { if ((int)((LOG_CRIT))<=(int)coap_get_log_level()) coap_log_impl((LOG_CRIT), "coap_register_async: insufficient memory\n"); } while(0);
    return 
# 54 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/async.c" 3 4
          ((void *)0)
# 54 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/async.c"
              ;
  }
...
coap_find_async(coap_context_t *context, coap_session_t *session, coap_tid_t id) {
  ...
  do { for ((tmp) = (context->async_state); tmp; (tmp) = (tmp)->next) { if ((tmp)->session == (session) && (tmp)->id == (id)) break; } } while(0);
  return tmp;
}
...
coap_remove_async(coap_context_t *context, coap_session_t *session,
  ...
  *s = tmp;
  return tmp != 
# 97 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/async.c" 3 4
               ((void *)0)
# 97 "/home/dieter/Development/esp-idf/components/coap/libcoap/src/async.c"
                   ;
}
