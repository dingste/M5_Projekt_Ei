# 1 "/home/dieter/Development/esp-idf/components/bootloader_support/src/bootloader_clock.c"
# 1 "/home/dieter/Development/M5_Projekt_Ei/build/bootloader_support//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/bootloader_support/src/bootloader_clock.c"
# 14 "/home/dieter/Development/esp-idf/components/bootloader_support/src/bootloader_clock.c"
...
# 15 "/home/dieter/Development/esp-idf/components/bootloader_support/src/bootloader_clock.c" 2
...
# 16 "/home/dieter/Development/esp-idf/components/bootloader_support/src/bootloader_clock.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/soc/esp32/include/soc/rtc.h" 2
# 1 "/home/dieter/Development/xtensa-esp32-elf/lib/gcc/xtensa-esp32-elf/8.2.0/include/stddef.h" 1 3 4
...
# 17 "/home/dieter/Development/esp-idf/components/bootloader_support/src/bootloader_clock.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/bootloader_support/src/bootloader_clock.c" 2
...
# 19 "/home/dieter/Development/esp-idf/components/bootloader_support/src/bootloader_clock.c" 2
...
static inline void __attribute__((section(".iram1" "." "3"))) uart_tx_wait_idle(uint8_t uart_no) {
    uint32_t status;
    do {
...
# 22 "/home/dieter/Development/esp-idf/components/bootloader_support/src/bootloader_clock.c" 2
...
# 23 "/home/dieter/Development/esp-idf/components/bootloader_support/src/bootloader_clock.c" 2
...
void bootloader_clock_configure(void)
{
    ...
    uart_tx_wait_idle(0);
# 44 "/home/dieter/Development/esp-idf/components/bootloader_support/src/bootloader_clock.c"
    int cpu_freq_mhz = 80;

    uint32_t chip_ver_reg = ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff5A000 + 0x00c))) >= 0x3ff00000) && (((0x3ff5A000 + 0x00c))) <= 0x3ff13FFC)), (!(((((0x3ff5A000 + 0x00c))) >= 0x3ff00000) && (((0x3ff5A000 + 0x00c))) <= 0x3ff13FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); 
# 46 "/home/dieter/Development/esp-idf/components/bootloader_support/src/bootloader_clock.c" 3 4
                           ((
# 46 "/home/dieter/Development/esp-idf/components/bootloader_support/src/bootloader_clock.c"
                           "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!(((((0x3ff5A000 + 0x00c))) >= 0x3ff00000) && (((0x3ff5A000 + 0x00c))) <= 0x3ff13FFC))
# 46 "/home/dieter/Development/esp-idf/components/bootloader_support/src/bootloader_clock.c" 3 4
                           ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/bootloader_support/src/bootloader_clock.c", 46, __func__, 
# 46 "/home/dieter/Development/esp-idf/components/bootloader_support/src/bootloader_clock.c"
                           "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!(((((0x3ff5A000 + 0x00c))) >= 0x3ff00000) && (((0x3ff5A000 + 0x00c))) <= 0x3ff13FFC))"
# 46 "/home/dieter/Development/esp-idf/components/bootloader_support/src/bootloader_clock.c" 3 4
                           ))
# 46 "/home/dieter/Development/esp-idf/components/bootloader_support/src/bootloader_clock.c"
                           ; } while(0);; (*(volatile uint32_t *)((0x3ff5A000 + 0x00c))); });
    if ((chip_ver_reg & ((0x1)<<(15))) == 0 &&
            ((DPORT_REG_READ((0x3ff00000 + 0x03C)) >> (0)) & (0x3)) == 2) {
        cpu_freq_mhz = 240;
    }
...
# 74 "/home/dieter/Development/esp-idf/components/bootloader_support/src/bootloader_clock.c"
}
