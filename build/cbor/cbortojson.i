# 1 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c"
# 1 "/home/dieter/Development/M5_Projekt_Ei/build/cbor//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c"
# 33 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c"
...
# 34 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c" 2
# 1 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cborjson.h" 1
# 35 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cborjson.h"
...
static __inline__ CborError cbor_value_to_json(FILE *out, const CborValue *value, int flags)
{
    CborValue copy = *value;
    return cbor_value_to_json_advance(out, &copy, flags);
}
# 35 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c" 2
...
# 36 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c" 2
...
# 39 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c" 2
# 149 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c"
...
# 187 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c" 3 4
   ((
# 187 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c"
   err == CborNoError
# 187 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c" 3 4
   ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c", 187, __func__, 
# 187 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c"
   "err == CborNoError"
# 187 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c" 3 4
   ))
...
# 217 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c" 3 4
   ((
# 217 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c"
   err == CborNoError
# 217 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c" 3 4
   ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c", 217, __func__, 
# 217 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c"
   "err == CborNoError"
# 217 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c" 3 4
   ))
# 217 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c"
    ...
    for (i = 0; n - i >= 3; i += 3) {
        ...
        if (
# 222 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c" 3 4
           0
# 222 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c"
                ) {
...
static CborError add_value_metadata(FILE *out, CborType type, const ConversionStatus *status)
{
    ...
    if (flags & TypeWasTagged) {
        ...
        if (fprintf(out, "\"tag\":\"%" 
# 292 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c" 3 4
                                      "ll" 
# 292 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c"
                                      "u" "\"%s", status->lastTag,
    ...
    if (flags & NumberPrecisionWasLost)
        if (fprintf(out, ",\"v\":\"%c%" 
# 311 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c" 3 4
                                       "ll" 
# 311 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c"
                                       "x" "\"", flags & NumberWasNegative ? '-' : '+',
...
static CborError tagged_value_to_json(FILE *out, CborValue *it, int flags, ConversionStatus *status)
{
    ...
    if (flags & CborConvertTagsToObjects) {
        ...
        if (fprintf(out, "{\"tag%" 
# 346 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c" 3 4
                                  "ll" 
# 346 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c"
                                  "u" "\":", tag) < 0)
            return CborErrorIO;
        ...
        if (flags & CborConvertAddMetadata && status->flags) {
            if (fprintf(out, ",\"tag%" 
# 354 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c" 3 4
                                      "ll" 
# 354 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c"
                                      "u" "$cbor\":{", tag) < 0 ||
...
static CborError stringify_map_key(char **key, CborValue *it, int flags, CborType type)
{
    ...
    if (memstream == 
# 411 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c" 3 4
                    ((void *)0)
# 411 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c"
                        )
        return CborErrorOutOfMemory;
    CborError err = cbor_value_to_pretty_advance(memstream, it);

    if (__builtin_expect(!!(fclose(memstream) < 0 || *key == 
# 415 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c" 3 4
       ((void *)0)
# 415 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c"
       ), 0))
...
static CborError map_to_json(FILE *out, CborValue *it, int flags, ConversionStatus *status)
{
    ...
    while (!cbor_value_at_end(it)) {
        ...
        if (__builtin_expect(!!(keyType == CborTextStringType), 1)) {
            size_t n = 0;
...
static CborError value_to_json(FILE *out, CborValue *it, int flags, CborType type, ConversionStatus *status)
{
    ...
    case CborSimpleType: {
        ...
        if (fprintf(out, "\"simple(%" 
# 573 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c" 3 4
                                     "hh" 
# 573 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c"
                                     "u" ")\"", simple_type) < 0)
            return CborErrorIO;
        break;
    }
...
# 590 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c" 3 4
       _Bool 
# 590 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c"
            val;
    ...
    case CborDoubleType: {
        double val;
        if (
# 600 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c" 3 4
           0
# 600 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c"
                ) {
            float f;
    case CborFloatType:
            status->flags = TypeWasNotNative;
...
# 606 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c" 3 4
                  0
# 606 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c"
                       ) {
            uint16_t f16;
    case CborHalfFloatType:
        ...
        int r = 
# 622 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c" 3 4
               (__builtin_fpclassify (0, 1, 4, 3, 2, 
# 622 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c"
               val
# 622 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c" 3 4
               ))
# 622 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c"
                              ;
        if (r == 
# 623 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c" 3 4
                0 
# 623 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c"
                       || r == 
# 623 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c" 3 4
                               1
# 623 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c"
            ...
            if (fprintf(out, "null") < 0)
                return CborErrorIO;
            status->flags |= r == 
# 626 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c" 3 4
                                 0 
# 626 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c"
                                        ? NumberWasNaN :
            ...
            if ((double)ival == fabs(val)) {
                ...
                r = fprintf(out, "%s%" 
# 632 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c" 3 4
                                      "ll" 
# 632 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c"
                                      "u", val < 0 ? "-" : "", ival);
                status->flags |= TypeWasNotNative;
            } else {

                r = fprintf(out, "%." "17" "g", val);
            }
            if (r < 0)
                return CborErrorIO;
        }
...
# 651 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c"
...
# 693 "/home/dieter/Development/esp-idf/components/cbor/tinycbor/src/cbortojson.c"
CborError cbor_value_to_json_advance(FILE *out, CborValue *value, int flags)
{
