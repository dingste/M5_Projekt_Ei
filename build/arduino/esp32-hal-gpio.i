...
# 19 "/home/dieter/Development/M5_Projekt_Ei/components/arduino/cores/esp32/esp32-hal-gpio.c" 2
...
# 21 "/home/dieter/Development/M5_Projekt_Ei/components/arduino/cores/esp32/esp32-hal-gpio.c" 2
# 1 "/home/dieter/Development/esp-idf/components/esp32/include/rom/gpio.h" 1
# 22 "/home/dieter/Development/M5_Projekt_Ei/components/arduino/cores/esp32/esp32-hal-gpio.c" 2
...
const __attribute__((section(".dram1" "." "15"))) esp32_gpioMux_t esp32_gpioMux[40]={
    {0x44, 11, 11, 1},
    {0x88, -1, -1, -1},
    {0x40, 12, 12, 2},
    {0x84, -1, -1, -1},
...
# 21 "/home/dieter/Development/esp-idf/components/driver/include/driver/rtc_io.h"
...
# 22 "/home/dieter/Development/esp-idf/components/driver/include/driver/rtc_io.h" 2
...
extern void __attribute__((section(".iram1" "." "16"))) __pinMode(uint8_t pin, uint8_t mode)
{
...
extern void __attribute__((section(".iram1" "." "17"))) __digitalWrite(uint8_t pin, uint8_t val)
{
    if(val) {
        if(pin < 32) {
...
extern int __attribute__((section(".iram1" "." "18"))) __digitalRead(uint8_t pin)
{
    if(pin < 32) {
...
static void __attribute__((section(".iram1" "." "19"))) __onPinInterrupt()
{
