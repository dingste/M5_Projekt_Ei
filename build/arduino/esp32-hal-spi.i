...
# 1 "/home/dieter/Development/esp-idf/components/esp32/include/rom/ets_sys.h" 1
# 21 "/home/dieter/Development/M5_Projekt_Ei/components/arduino/cores/esp32/esp32-hal-spi.c" 2

# 1 "/home/dieter/Development/esp-idf/components/esp32/include/esp_intr.h" 1
# 15 "/home/dieter/Development/esp-idf/components/esp32/include/esp_intr.h"
       

# 1 "/home/dieter/Development/esp-idf/components/esp32/include/esp_intr_alloc.h" 1
# 17 "/home/dieter/Development/esp-idf/components/esp32/include/esp_intr.h" 2
# 23 "/home/dieter/Development/M5_Projekt_Ei/components/arduino/cores/esp32/esp32-hal-spi.c" 2
# 1 "/home/dieter/Development/esp-idf/components/esp32/include/rom/gpio.h" 1
# 24 "/home/dieter/Development/M5_Projekt_Ei/components/arduino/cores/esp32/esp32-hal-spi.c" 2
...
static inline uint32_t __attribute__((section(".iram1" "." "15"))) DPORT_REG_READ(uint32_t reg)
{
...
static inline uint32_t __attribute__((section(".iram1" "." "16"))) DPORT_SEQUENCE_REG_READ(uint32_t reg)
{
...
static inline uint32_t __attribute__((section(".iram1" "." "17"))) DPORT_READ_PERI_REG(uint32_t reg)
{
...
static spi_t _spi_bus_array[4] = {
    {(volatile spi_dev_t *)(0x3ff43000), 0},
    {(volatile spi_dev_t *)(0x3ff42000), 1},
    {(volatile spi_dev_t *)(0x3ff64000), 2},
    {(volatile spi_dev_t *)(0x3ff65000), 3}
};
# 73 "/home/dieter/Development/M5_Projekt_Ei/components/arduino/cores/esp32/esp32-hal-spi.c"
void spiAttachSCK(spi_t * spi, int8_t sck)
{
    if(!spi) {
        return;
...
# 430 "/home/dieter/Development/M5_Projekt_Ei/components/arduino/cores/esp32/esp32-hal-spi.c"
    if(spi_num == 2) {
        (*((volatile uint32_t *)((((0x3ff00000 + 0x0C0)))))) = (uint32_t)(((DPORT_READ_PERI_REG((0x3ff00000 + 0x0C0))|(DPORT_SPI_CLK_EN))));
        (*((volatile uint32_t *)((((0x3ff00000 + 0x0C4)))))) = (uint32_t)(((DPORT_READ_PERI_REG((0x3ff00000 + 0x0C4))&(~(DPORT_SPI_RST)))));
    } else if(spi_num == 3) {
        (*((volatile uint32_t *)((((0x3ff00000 + 0x0C0)))))) = (uint32_t)(((DPORT_READ_PERI_REG((0x3ff00000 + 0x0C0))|(DPORT_SPI_CLK_EN_2))));
        (*((volatile uint32_t *)((((0x3ff00000 + 0x0C4)))))) = (uint32_t)(((DPORT_READ_PERI_REG((0x3ff00000 + 0x0C4))&(~(DPORT_SPI_RST_2)))));
    } else {
        (*((volatile uint32_t *)((((0x3ff00000 + 0x0C0)))))) = (uint32_t)(((DPORT_READ_PERI_REG((0x3ff00000 + 0x0C0))|(DPORT_SPI_CLK_EN_1))));
        (*((volatile uint32_t *)((((0x3ff00000 + 0x0C4)))))) = (uint32_t)(((DPORT_READ_PERI_REG((0x3ff00000 + 0x0C4))&(~(DPORT_SPI_RST_1)))));
    }
...
void __attribute__((section(".iram1" "." "18"))) spiWriteByteNL(spi_t * spi, uint8_t data)
{
    if(!spi) {
        return;
    }
...
void __attribute__((section(".iram1" "." "19"))) spiWriteShortNL(spi_t * spi, uint16_t data)
{
    if(!spi) {
        return;
    }
...
void __attribute__((section(".iram1" "." "20"))) spiWriteLongNL(spi_t * spi, uint32_t data)
{
    if(!spi) {
        return;
    }
...
void __attribute__((section(".iram1" "." "21"))) spiWritePixelsNL(spi_t * spi, const void * data_in, uint32_t len){
    size_t longs = len >> 2;
    if(len & 3){
        longs++;
    }
