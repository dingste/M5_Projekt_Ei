# 1 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_l2c.c"
# 1 "/home/dieter/Development/M5_Projekt_Ei/build/bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_l2c.c"
# 25 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_l2c.c"
...
# 26 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_l2c.c" 2
...
# 27 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_l2c.c" 2
...
# 31 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_l2c.c" 2
...
# 32 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_l2c.c" 2
...
# 33 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_l2c.c" 2
...
# 35 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_l2c.c" 2
...
# 58 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_l2c.c"
void smp_l2cap_if_init (void)
{
    tL2CAP_FIXED_CHNL_REG fixed_reg;
    {if ((*smp_cb_ptr).trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "SMDBG l2c %s" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __func__); };};
...
# 71 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_l2c.c" 3 4
                                  ((void *)0)
# 71 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_l2c.c"
                                      ;
...
# 102 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_l2c.c"
static void smp_connect_callback (UINT16 channel, BD_ADDR bd_addr, BOOLEAN connected, UINT16 reason,
                                  tBT_TRANSPORT transport)
{
    ...
    {if ((*smp_cb_ptr).trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "SMDBG l2c %s\n" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __FUNCTION__); };};
...
# 127 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_l2c.c" 3 4
                                           1
# 127 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_l2c.c"
                                               ;
...
# 135 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_l2c.c" 3 4
                                                      ((void *)0)
# 135 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_l2c.c"
                                                          );
            }
        } else {
...
# 156 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_l2c.c"
static void smp_data_received(UINT16 channel, BD_ADDR bd_addr, BT_HDR *p_buf)
{
    tSMP_CB *p_cb = &(*smp_cb_ptr);
    UINT8 *p = (UINT8 *)(p_buf + 1) + p_buf->offset;
    UINT8 cmd ;
    {if ((*smp_cb_ptr).trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "\nSMDBG l2c %s\n" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __FUNCTION__); };};

    {cmd = (UINT8)(*(p)); (p) += 1;};


    if ((0x0E < cmd) || (0x01 > cmd)) {
        {if ((*smp_cb_ptr).trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_SMP", "\033[0;" "33" "m" "W" " (%d) %s: " "Ignore received command with RESERVED code 0x%02x\n" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", cmd); };};
        free((p_buf));
        return;
    }
    ...
    if (memcmp(&bd_addr[0], p_cb->pairing_bda, 6) == 0) {
        ...
        if (cmd == 0x03) {
            {if ((*smp_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "in %s cmd = 0x%02x, peer_auth_req = 0x%02x," "loc_auth_req = 0x%02x\n" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __FUNCTION__, cmd, p_cb->peer_auth_req, p_cb->loc_auth_req); };}
...
# 218 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_l2c.c"
static void smp_tx_complete_callback (UINT16 cid, UINT16 num_pkt)
{
    tSMP_CB *p_cb = &(*smp_cb_ptr);
    ...
    if (p_cb->total_tx_unacked >= num_pkt) {
        ...
        {if ((*smp_cb_ptr).trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_SMP", "\033[0;" "31" "m" "E" " (%d) %s: " "Unexpected %s: num_pkt = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __func__, num_pkt); };};
    }
...
# 250 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_l2c.c"
                                    ...
                                    UINT16 reason, tBT_TRANSPORT transport)
{
    ...
    if (transport != 1) {
        {if ((*smp_cb_ptr).trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "%s is called on unexpected transport %d\n" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", __func__, transport); };}
                                              ;
        return;
    }
    ...
    if (connected) {
        if (!p_cb->connect_initialized) {
            p_cb->connect_initialized = 
# 276 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_l2c.c" 3 4
                                       1
# 276 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_l2c.c"
                                           ;
...
# 281 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_l2c.c" 3 4
                                                                   ((void *)0)
# 281 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_l2c.c"
                                                                       );
        }
    } else {
        int_data.reason = reason;
...
# 300 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_l2c.c"
static void smp_br_data_received(UINT16 channel, BD_ADDR bd_addr, BT_HDR *p_buf)
{
    tSMP_CB *p_cb = &(*smp_cb_ptr);
    UINT8 *p = (UINT8 *)(p_buf + 1) + p_buf->offset;
    ...
    if ((0x0E < cmd) || (0x01 > cmd)) {
        {if ((*smp_cb_ptr).trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_SMP", "\033[0;" "33" "m" "W" " (%d) %s: " "Ignore received command with RESERVED code 0x%02x" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", cmd); };};
        free((p_buf));
        return;
    }
    ...
    if (0x01 == cmd) {
        if ((p_cb->state == SMP_STATE_IDLE) && (p_cb->br_state == SMP_BR_STATE_IDLE)) {
            p_cb->role = 0x01;
            p_cb->smp_over_br = 
# 320 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_l2c.c" 3 4
                               1
# 320 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_l2c.c"
                                   ;
            memcpy(&p_cb->pairing_bda[0], bd_addr, 6);
        } else if (memcmp(&bd_addr[0], p_cb->pairing_bda, 6)) {
            free((p_buf));
