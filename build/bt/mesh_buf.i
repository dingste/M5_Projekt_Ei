# 1 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_common/mesh_buf.c"
...
# 9 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_common/mesh_buf.c" 2
...
# 11 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_common/mesh_buf.c" 2
...
# 13 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_common/mesh_buf.c" 2
# 1 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_common/include/mesh_trace.h" 1
# 14 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_common/mesh_buf.c" 2
...
void net_buf_simple_add_be16(struct net_buf_simple *buf, u16_t val)
{
    ...
    val = ((u16_t) ((((val) >> 8) & 0xff) | (((val) & 0xff) << 8)));
    memcpy(net_buf_simple_add(buf, sizeof(val)), &val, sizeof(val));
}
...
void net_buf_simple_add_be32(struct net_buf_simple *buf, u32_t val)
{
    ...
    val = ((u32_t) ((((val) >> 24) & 0xff) | (((val) >> 8) & 0xff00) | (((val) & 0xff00) << 8) | (((val) & 0xff) << 24)));
    memcpy(net_buf_simple_add(buf, sizeof(val)), &val, sizeof(val));
}
...
struct net_buf *net_buf_slist_get(sys_slist_t *list)
{
    ...
    if (!buf) {
        return 
# 262 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_common/mesh_buf.c" 3 4
              ((void *)0)
# 262 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_common/mesh_buf.c"
                  ;
    }
    ...
    frag->frags = 
# 278 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_common/mesh_buf.c" 3 4
                 ((void *)0)
# 278 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_common/mesh_buf.c"
                     ;
...

{
    ...
    while (buf) {
        ...
        struct net_buf_pool *pool;
# 312 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_common/mesh_buf.c"
        ...
        buf->frags = 
# 320 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_common/mesh_buf.c" 3 4
                    ((void *)0)
# 320 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_common/mesh_buf.c"
                        ;
...
{
    struct net_buf *buf = 
# 375 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_common/mesh_buf.c" 3 4
                         ((void *)0)
# 375 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_common/mesh_buf.c"
                             ;
    unsigned int key;
    int i;
    ...
    ;
    return 
# 406 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_common/mesh_buf.c" 3 4
          ((void *)0)
# 406 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_common/mesh_buf.c"
              ;
...
success:
    ...
    if (size) {
        ...
        if (!buf->__buf) {
            ;
            return 
# 415 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_common/mesh_buf.c" 3 4
                  ((void *)0)
# 415 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_common/mesh_buf.c"
                      ;
        }
    } else {
        ;
        buf->__buf = 
# 419 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_common/mesh_buf.c" 3 4
                    ((void *)0)
# 419 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_common/mesh_buf.c"
                        ;
    }
    ...
    buf->flags = 0;
    buf->frags = 
# 424 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_common/mesh_buf.c" 3 4
                ((void *)0)
# 424 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_common/mesh_buf.c"
                    ;
    buf->size = size;
    net_buf_reset(buf);
...
# 447 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_common/mesh_buf.c"
struct net_buf *net_buf_alloc_fixed(struct net_buf_pool *pool, s32_t timeout)
{
    const struct net_buf_pool_fixed *fixed = pool->alloc->alloc_data;
