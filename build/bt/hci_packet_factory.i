# 1 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/hci/hci_packet_factory.c"
# 1 "/home/dieter/Development/M5_Projekt_Ei/build/bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/hci/hci_packet_factory.c"
# 19 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/hci/hci_packet_factory.c"
...
# 20 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/hci/hci_packet_factory.c" 2
...
# 22 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/hci/hci_packet_factory.c" 2
...
# 24 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/hci/hci_packet_factory.c" 2
...
# 25 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/hci/hci_packet_factory.c" 2
# 1 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/hci/include/hci/hci_internals.h" 1
# 26 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/hci/hci_packet_factory.c" 2
...
# 27 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/hci/hci_packet_factory.c" 2
...
# 28 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/hci/hci_packet_factory.c" 2
...
static BT_HDR *make_set_adv_report_flow_control(uint8_t enable, uint16_t num, uint16_t lost_threshold)
{
    ...
    BT_HDR *packet = make_command(((0x3F << 10) | (0x02 <<7) | (0x09 << 0)), parameter_size, &stream);

    {*(stream)++ = (UINT8)(enable);};
    {*(stream)++ = (UINT8)(num); *(stream)++ = (UINT8)((num) >> 8);};
    {*(stream)++ = (UINT8)(lost_threshold); *(stream)++ = (UINT8)((lost_threshold) >> 8);};
    return packet;
}
...
# 221 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/hci/hci_packet_factory.c" 3 4
                                  ((void *)0)
# 221 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/hci/hci_packet_factory.c"
                                      );
}
...
static BT_HDR *make_command(uint16_t opcode, size_t parameter_size, uint8_t **stream_out)
{
    ...
    if (stream_out != 
# 232 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/hci/hci_packet_factory.c" 3 4
                     ((void *)0)
# 232 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/hci/hci_packet_factory.c"
                         ) {
        *stream_out = stream;
    }
...
static BT_HDR *make_packet(size_t data_size)
{
    BT_HDR *ret = (BT_HDR *)calloc(1, (sizeof(BT_HDR) + data_size));
    
# 242 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/hci/hci_packet_factory.c" 3 4
   ((
# 242 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/hci/hci_packet_factory.c"
   ret
# 242 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/hci/hci_packet_factory.c" 3 4
   ) ? (void)0 : __assert_func ("/home/dieter/Development/esp-idf/components/bt/host/bluedroid/hci/hci_packet_factory.c", 242, __func__, 
# 242 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/hci/hci_packet_factory.c"
   "ret"
# 242 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/hci/hci_packet_factory.c" 3 4
   ))
