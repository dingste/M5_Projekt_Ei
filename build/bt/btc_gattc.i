# 1 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c"
# 1 "/home/dieter/Development/M5_Projekt_Ei/build/bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c"
# 15 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c"
...
# 16 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c" 2
# 1 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/include/btc_gattc.h" 1
# 18 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/include/btc_gattc.h"
...
# 19 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/include/btc_gattc.h" 2
...
esp_gatt_status_t btc_ble_gattc_get_db(uint16_t conn_id, uint16_t start_handle, uint16_t end_handle,
                                       esp_gattc_db_elem_t *db, uint16_t *count);
# 19 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c" 2
...
# 20 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c" 2
...
# 21 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c" 2
...
# 24 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c" 2
    ...
    switch (msg->act) {
        ...
        case 37: {
            if (p_src_data->read.p_value && p_src_data->read.p_value->p_value) {
                p_dest_data->read.p_value = (tBTA_GATT_UNFMT *)malloc((sizeof(tBTA_GATT_UNFMT) + p_src_data->read.p_value->len));
        ...
        case 40: {
            if (p_src_data->get_addr_list.bda_list != 
# 146 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                                                     ((void *)0)
# 146 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                                                         ) {
                uint8_t num_addr = p_src_data->get_addr_list.num_addr;
                p_dest_data->get_addr_list.bda_list = (BD_ADDR *)malloc((sizeof(BD_ADDR) * num_addr));
...
static void btc_gattc_free_req_data(btc_msg_t *msg)
{
    ...
    switch (msg->act) {
        ...
        case 37: {
            if (arg->read.p_value) {
                free((arg->read.p_value));
            }
            break;
        }
        case 40: {
            if (arg->get_addr_list.bda_list) {
                free((arg->get_addr_list.bda_list));
            }
            break;
        }
        default:
    ...
    switch(type) {
        ...
        case ESP_GATT_DB_SECONDARY_SERVICE: {
            ...
            for (int i = 0; i < db_size; i++) {
                svc_result->is_primary = (db[offset + i].type == BTGATT_DB_PRIMARY_SERVICE) ? 
# 252 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                                                                                             1 
# 252 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                                                                                                  : 
# 252 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                                                                                                    0
# 252 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c"
        ...
        default:
            {if (2 >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_BTC", "\033[0;" "33" "m" "W" " (%d) %s: " "%s(), Not support type(%d)" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __func__, type); };};
            break;
    }
}
...
# 308 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                                                                ((void *)0)
# 308 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                                                                    );
    }
}
...
# 317 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                             ((void *)0)
# 317 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                                 ;
    int svc_num = 0;
    tBT_UUID *bta_uuid = 
# 319 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                        ((void *)0)
# 319 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                            ;
    if (svc_uuid) {
        bta_uuid = malloc((sizeof(tBT_UUID)));
                                             ...
                                             uint16_t *count, uint16_t offset)
{
    esp_gatt_status_t status;
    btgatt_db_element_t *db = 
# 358 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                             ((void *)0)
# 358 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                                 ;
    int char_num = 0;
                                              ...
                                              uint16_t *count, uint16_t offset)
{
    esp_gatt_status_t status;
    btgatt_db_element_t *db = 
# 386 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                             ((void *)0)
# 386 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                                 ;
    int descr_num = 0;
                                                 ...
                                                 uint16_t *count)
{
    esp_gatt_status_t status;
    btgatt_db_element_t *db = 
# 416 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                             ((void *)0)
# 416 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                                 ;
    int char_num = 0;
    tBT_UUID bta_uuid = {0};
                                                  ...
                                                  uint16_t *count)
{
    esp_gatt_status_t status;
    btgatt_db_element_t *db = 
# 449 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                             ((void *)0)
# 449 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                                 ;
    int descr_num = 0;
                                                         ...
                                                         uint16_t *count)
{
    esp_gatt_status_t status;
    btgatt_db_element_t *db = 
# 484 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                             ((void *)0)
# 484 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                                 ;
    int descr_num = 0;
    tBT_UUID bta_descr_uuid = {0};
    btc_to_bta_uuid(&bta_descr_uuid, &descr_uuid);
                                                    ...
                                                    uint16_t *count)
{
    esp_gatt_status_t status;
    btgatt_db_element_t *db = 
# 518 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                             ((void *)0)
# 518 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                                 ;
    int incl_num = 0;
    tBT_UUID bta_uuid = {0};

    if (incl_uuid != 
# 522 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                    ((void *)0)
# 522 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                        ) {
        btc_to_bta_uuid(&bta_uuid, incl_uuid);
        BTA_GATTC_GetIncludeService(conn_id, start_handle, end_handle, &bta_uuid, &db, &incl_num);
    } else {
        BTA_GATTC_GetIncludeService(conn_id, start_handle, end_handle, 
# 526 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                                                                      ((void *)0)
# 526 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                                                                          , &db, &incl_num);
    }
...
esp_gatt_status_t btc_ble_gattc_get_db(uint16_t conn_id, uint16_t start_handle, uint16_t end_handle,
                                       esp_gattc_db_elem_t *db, uint16_t *count)
{
    btgatt_db_element_t *get_db = 
# 566 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                                 ((void *)0)
# 566 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                                     ;
    int num = 0;
    tBT_UUID bta_uuid;
    uint16_t db_size = 0;
...
static void btc_gattc_read_multiple_char(btc_ble_gattc_args_t *arg)
{
    ...
    memcpy(bta_multi.handles, arg->read_multiple.handles, 10);
...
# 749 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                                                        1
# 749 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                                                            );
        break;
...
# 793 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                                                          ((void *)0)
# 793 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                                                              );
        break;
    }
    case 3: {
...
# 875 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                                                      1
# 875 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                                                          ) ? 
# 875 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                                                              1 
# 875 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c"
...
# 875 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c"
        ...
        if (notify->is_notify == 
# 880 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                                0
# 880 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                                     ) {
...
# 955 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                                                        1
# 955 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                                                            ) ? 
# 955 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                                                                1 
# 955 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c"
...
# 955 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/btc/profile/std/gatt/btc_gattc.c"
    ...
    case 15: {
        ...
        gattc_if = ((uint8_t)(srvc_change->conn_id));
    ...
    case 38: {
        ...
        gattc_if = ((uint8_t)(queue_full->conn_id));
        param.queue_full.conn_id = (((uint16_t)(queue_full->conn_id)) >> 8);
    ...
    case 41:
        gattc_if = ((uint8_t)(arg->dis_cmpl.conn_id));
        param.dis_srvc_cmpl.status = arg->dis_cmpl.status;
        param.dis_srvc_cmpl.conn_id = (((uint16_t)(arg->dis_cmpl.conn_id)) >> 8);
        btc_gattc_cb_to_app(ESP_GATTC_DIS_SRVC_CMPL_EVT, gattc_if, &param);
        break;
    default:
        {if (2 >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTC", "D" " (%d) %s: " "%s: Unhandled event (%d)!" "\033[0m" "\n", esp_log_timestamp(), "BT_BTC", __FUNCTION__, msg->act); };};
        break;
    }
