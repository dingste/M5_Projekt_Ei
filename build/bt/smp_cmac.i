# 1 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c"
# 1 "/home/dieter/Development/M5_Projekt_Ei/build/bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c"
# 25 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c"
...
# 26 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c" 2
...
# 27 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c" 2
...
# 31 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c" 2
...
# 33 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c" 2
...
# 34 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c" 2
...
# 35 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c" 2
...
{
# 64 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c"
}
# 78 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c"
...
# 95 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c"
static void leftshift_onebit(UINT8 *input, UINT8 *output)
{
    UINT8 i, overflow = 0 , next_overflow = 0;
    {if ((*smp_cb_ptr).trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "leftshift_onebit " "\033[0m" "\n", esp_log_timestamp(), "BT_SMP"); };};
...
# 116 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c"
static void cmac_aes_cleanup(void)
{
    if (cmac_cb.text != 
# 118 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c" 3 4
                       ((void *)0)
# 118 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c"
                           ) {
        free((cmac_cb.text));
    }
    memset(&cmac_cb, 0, sizeof(tCMAC_CB));
}
# 133 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c"
static BOOLEAN cmac_aes_k_calculate(BT_OCTET16 key, UINT8 *p_signature, UINT16 tlen)
{
    ...
    {if ((*smp_cb_ptr).trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "cmac_aes_k_calculate " "\033[0m" "\n", esp_log_timestamp(), "BT_SMP"); };};
    ...
    if (!err) {
        ...
        {if ((*smp_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "tlen = %d p_mac = %p" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", tlen, p_mac); };};
        {if ((*smp_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "p_mac[0] = 0x%02x p_mac[1] = 0x%02x p_mac[2] = 0x%02x p_mac[3] = 0x%02x" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", *p_mac, *(p_mac + 1), *(p_mac + 2), *(p_mac + 3)); };}
                                                                         ;
        {if ((*smp_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "p_mac[4] = 0x%02x p_mac[5] = 0x%02x p_mac[6] = 0x%02x p_mac[7] = 0x%02x" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", *(p_mac + 4), *(p_mac + 5), *(p_mac + 6), *(p_mac + 7)); };}
                                                                               ;

        return 
# 164 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c" 3 4
              1
# 164 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c"
                  ;

    } else {
        return 
# 167 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c" 3 4
              0
# 167 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c"
                   ;
    }
}
# 180 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c"
static void cmac_prepare_last_block (BT_OCTET16 k1, BT_OCTET16 k2)
{

    BOOLEAN flag;

    {if ((*smp_cb_ptr).trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "cmac_prepare_last_block " "\033[0m" "\n", esp_log_timestamp(), "BT_SMP"); };};

    flag = ((cmac_cb.len % 16) == 0 && cmac_cb.len != 0) ? 
# 187 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c" 3 4
                                                                       1 
# 187 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c"
                                                                            : 
# 187 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c" 3 4
                                                                              0
# 187 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c"
    ...
    {if ((*smp_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "flag = %d round = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", flag, cmac_cb.round); };};
...
# 209 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c"
static void cmac_subkey_cont(tSMP_ENC *p)
{
    UINT8 k1[16], k2[16];
    UINT8 *pp = p->param_buf;
    {if ((*smp_cb_ptr).trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "cmac_subkey_cont " "\033[0m" "\n", esp_log_timestamp(), "BT_SMP"); };};
...
# 250 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c"
static BOOLEAN cmac_generate_subkey(BT_OCTET16 key)
{
    BT_OCTET16 z = {0};
    BOOLEAN ret = 
# 253 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c" 3 4
                     1
# 253 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c"
                         ;
    tSMP_ENC output;
    {if ((*smp_cb_ptr).trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " " cmac_generate_subkey" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP"); };};

    if (SMP_Encrypt(key, 16, z, 16, &output)) {
        cmac_subkey_cont(&output);;
    } else {
        ret = 
# 260 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c" 3 4
             0
# 260 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c"
                  ;
    }

    return ret;
}
# 280 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c"
                                 ...
                                 UINT16 tlen, UINT8 *p_signature)
{
    ...
    BOOLEAN ret = 
# 285 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c" 3 4
                 0
# 285 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c"
                      ;
    ...
    {if ((*smp_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_SMP", "D" " (%d) %s: " "AES128_CMAC started, allocate buffer size = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP", len); };};

    if ((cmac_cb.text = (UINT8 *)malloc((len))) != 
# 296 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c" 3 4
                                                    ((void *)0)
# 296 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c"
                                                        ) {
        cmac_cb.round = n;
        ...
        if (input != 
# 302 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c" 3 4
                    ((void *)0) 
# 302 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c"
                         && length > 0) {
        ...
        ret = 
# 317 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c" 3 4
             0
# 317 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/smp/smp_cmac.c"
                  ;
        {if ((*smp_cb_ptr).trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_SMP", "\033[0;" "31" "m" "E" " (%d) %s: " "No resources" "\033[0m" "\n", esp_log_timestamp(), "BT_SMP"); };};
    }
