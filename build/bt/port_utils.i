# 1 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
# 1 "/home/dieter/Development/M5_Projekt_Ei/build/bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
# 24 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
...
# 25 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 2
...
# 27 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 2
# 1 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/include/stack/rfcdefs.h" 1
# 28 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 2
...
# 29 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 2
...
# 30 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 2
...
# 32 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/include/stack/l2c_api.h" 2
...
# 31 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 2

# 1 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/include/btm_int.h" 1
# 34 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/include/btm_int.h"
...
# 33 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 2
...
# 34 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 2
...
# 35 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 2
...
# 36 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 2
...
# 64 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
tPORT *port_allocate_port (UINT8 dlci, BD_ADDR bd_addr)
{
    tPORT *p_port = &(*rfc_cb_ptr).port.port[0];
    UINT8 xx, yy;

    for (xx = 0, yy = (*rfc_cb_ptr).rfc.last_port + 1; xx < 16; xx++, yy++) {
        if (yy >= 16) {
            yy = 0;
        }

        p_port = &(*rfc_cb_ptr).port.port[yy];
        if (!p_port->in_use) {
            memset (p_port, 0, sizeof (tPORT));

            p_port->in_use = 
# 78 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 3 4
                            1
# 78 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
                                ;
            p_port->inx = yy + 1;

            p_port->dlci = dlci;
            memcpy (p_port->bd_addr, bd_addr, 6);


            port_set_defaults (p_port);

            (*rfc_cb_ptr).rfc.last_port = yy;
            {if ((*rfc_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "rfc_cb.port.port[%d]:%p allocated, last_port:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM", yy, p_port, (*rfc_cb_ptr).rfc.last_port); };};
            {if ((*rfc_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "port_allocate_port:bd_addr:%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM", bd_addr[0], bd_addr[1], bd_addr[2], bd_addr[3], bd_addr[4], bd_addr[5]); };}
                                                                                                      ;
            return (p_port);
        }
    }
    ...
    return (
# 96 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 3 4
           ((void *)0)
# 96 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
               );
}
# 108 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
void port_set_defaults (tPORT *p_port)
{
    p_port->ev_mask = 0;
    p_port->p_callback = 
# 111 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 3 4
                            ((void *)0)
# 111 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
                                ;
    p_port->port_ctrl = 0;
    p_port->error = 0;
    p_port->line_status = 0;
    p_port->rx_flag_ev_pending = 
# 115 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 3 4
                                0
# 115 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
                                     ;
    p_port->peer_mtu = 127;
    ...
    p_port->tx.queue = fixed_queue_new(254);
    p_port->rx.queue = fixed_queue_new(254);
}
# 146 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
void port_select_mtu (tPORT *p_port)
{
    ...
    if (p_port->mtu == 0) {
        ...
        if (packet_size == 0) {
            ...
            {if ((*rfc_cb_ptr).trace_level >= 2 && (((2) > (3) ? (2) : (3)) >= 2)) {esp_log_write(ESP_LOG_WARN, "BT_RFCOMM", "\033[0;" "33" "m" "W" " (%d) %s: " "port_select_mtu bad packet size" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM"); };};
            p_port->mtu = 127;
        } else {
# 167 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
            if ((1691 + 4) >= packet_size) {
                p_port->mtu = ((1691 + 4) / packet_size * packet_size) - (5 + 1) - 4;
                {if ((*rfc_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "port_select_mtu selected %d based on connection speed" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM", p_port->mtu); };};
            } else {
                p_port->mtu = 1691 - (5 + 1);
                {if ((*rfc_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "port_select_mtu selected %d based on l2cap PDU size" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM", p_port->mtu); };};
            }
        }
    } else {
        {if ((*rfc_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "port_select_mtu application selected %d" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM", p_port->mtu); };};
    }
    p_port->credit_rx_max = (((1691 -13 -(5 + 1)) * 10) / p_port->mtu);
    if ( p_port->credit_rx_max > 10 ) {
        p_port->credit_rx_max = 10;
    }
    p_port->credit_rx_low = (((1691 -13 -(5 + 1)) * 4) / p_port->mtu);
    if ( p_port->credit_rx_low > 4 ) {
        p_port->credit_rx_low = 4;
    }
    p_port->rx_buf_critical = (((1691 -13 -(5 + 1)) * 15) / p_port->mtu);
    if ( p_port->rx_buf_critical > 15 ) {
        p_port->rx_buf_critical = 15;
    }
    {if ((*rfc_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "port_select_mtu credit_rx_max %d, credit_rx_low %d, rx_buf_critical %d" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM", p_port->credit_rx_max, p_port->credit_rx_low, p_port->rx_buf_critical); };}
                                                                                              ;
}
# 204 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
void port_release_port (tPORT *p_port)
{
    ...
    {if ((*rfc_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "port_release_port, p_port:%p" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM", p_port); };};
    while ((p_buf = (BT_HDR *)fixed_queue_dequeue(p_port->rx.queue, 0)) != 
# 213 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 3 4
                                                                          ((void *)0)
# 213 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
                                                                              ) {
        free((p_buf));
    }
...
# 219 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 3 4
                                                                          ((void *)0)
# 219 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
                                                                              ) {
        free((p_buf));
    }
    ...
    if (p_port->rfc.state == 0) {
        {if ((*rfc_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "rfc_port_closed DONE" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM"); };};
        if (p_port->rfc.p_mcb) {
        ...
        fixed_queue_free(p_port->tx.queue, 
# 238 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 3 4
                                          ((void *)0)
# 238 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
                                              );
        p_port->tx.queue = 
# 239 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 3 4
                          ((void *)0)
# 239 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
                              ;
        fixed_queue_free(p_port->rx.queue, 
# 240 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 3 4
                                          ((void *)0)
# 240 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
                                              );
        p_port->rx.queue = 
# 241 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 3 4
                          ((void *)0)
# 241 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
                              ;

        {if ((*rfc_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "port_release_port:p_port->keep_port_handle:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM", p_port->keep_port_handle); };};
        if ( p_port->keep_port_handle ) {
            {if ((*rfc_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "port_release_port:Initialize handle:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM", p_port->inx); };};
            ...
            p_port->state = 1;
            p_port->rfc.p_mcb = 
# 259 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 3 4
                                     ((void *)0)
# 259 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
                                         ;
            if (p_port->is_server) {
                p_port->dlci &= 0xfe;
            }
            ...
            memcpy (p_port->bd_addr, BT_BD_ANY, 6);
        } else {
            {if ((*rfc_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "port_release_port:Clean-up handle:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM", p_port->inx); };};
            rfc_port_timer_free (p_port);
            memset (p_port, 0, sizeof (tPORT));
        }
    }
}
# 283 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
tRFC_MCB *port_find_mcb (BD_ADDR bd_addr)
{
    int i;

    for (i = 0; i < 4; i++) {
        if (((*rfc_cb_ptr).port.rfc_mcb[i].state != 0)
                && !memcmp ((*rfc_cb_ptr).port.rfc_mcb[i].bd_addr, bd_addr, 6)) {

            {if ((*rfc_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "port_find_mcb: found  bd_addr:%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM", bd_addr[0], bd_addr[1], bd_addr[2], bd_addr[3], bd_addr[4], bd_addr[5]); };}
                                                                                                      ;
            {if ((*rfc_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "port_find_mcb: rfc_cb.port.rfc_mcb:index:%d, %p, lcid:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM", i, &(*rfc_cb_ptr).port.rfc_mcb[i], (*rfc_cb_ptr).port.rfc_mcb[i].lcid); };}
                                                                                       ;
            return (&(*rfc_cb_ptr).port.rfc_mcb[i]);
        }
    }
    {if ((*rfc_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "port_find_mcb: not found, bd_addr:%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM", bd_addr[0], bd_addr[1], bd_addr[2], bd_addr[3], bd_addr[4], bd_addr[5]); };}
                                                                                              ;
    return (
# 300 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 3 4
           ((void *)0)
# 300 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
               );
}
# 316 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
tPORT *port_find_mcb_dlci_port (tRFC_MCB *p_mcb, UINT8 dlci)
{
    ...
    if (!p_mcb) {
        return (
# 321 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 3 4
               ((void *)0)
# 321 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
                   );
    }

    if (dlci > 61) {
        return (
# 325 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 3 4
               ((void *)0)
# 325 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
                   );
    }

    inx = p_mcb->port_inx[dlci];
    if (inx == 0) {
        {if ((*rfc_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "port_find_mcb_dlci_port: p_mcb:%p, port_inx[dlci:%d] is 0" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM", p_mcb, dlci); };};
        return (
# 331 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 3 4
               ((void *)0)
# 331 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
                   );
    } else {
        return (&(*rfc_cb_ptr).port.port[inx - 1]);
    }
}
# 347 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
tPORT *port_find_dlci_port (UINT8 dlci)
{
    ...
    for (i = 0; i < 16; i++) {
        ...
        if (p_port->in_use && (p_port->rfc.p_mcb == 
# 355 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 3 4
                                                   ((void *)0)
# 355 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
                                                       )) {
            if (p_port->dlci == dlci) {
                return (p_port);
    ...
    return (
# 364 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 3 4
           ((void *)0)
# 364 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
               );
}
# 377 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
tPORT *port_find_port (UINT8 dlci, BD_ADDR bd_addr)
{
    ...
    for (i = 0; i < 16; i++) {
        ...
        if (p_port->in_use
                && (p_port->dlci == dlci)
                && !memcmp (p_port->bd_addr, bd_addr, 6)) {
            return (p_port);
        }
    }
    return (
# 390 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 3 4
           ((void *)0)
# 390 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
               );
}
# 405 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
UINT32 port_flow_control_user (tPORT *p_port)
{
    ...
    BOOLEAN fc = p_port->tx.peer_fc
                 ...
                 || (p_port->tx.queue_size > ((1691 -13 -(5 + 1)) * 10))
    ...
    if (fc) {
        ...
        event = 0x00010000 | 0x00020000;
    }

    return (event);
}
# 443 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
UINT32 port_get_signal_changes (tPORT *p_port, UINT8 old_signals, UINT8 signal)
{
    UINT8 changed_signals = (signal ^ old_signals);
    UINT32 events = 0;

    if (changed_signals & 0x01) {
        events |= 0x00000010;
    ...
    if (changed_signals & 0x04) {
        events |= 0x00000100;
    }

    if (changed_signals & 0x08) {
        events |= 0x00000020;
...
# 490 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
    ...
    if (p_port->rfc.p_mcb->flow == 2) {
        ...
        if (enable) {
            ...
            if ((p_port->credit_rx <= p_port->credit_rx_low)
                ...
                p_port->rx.peer_fc = 
# 518 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 3 4
                                    0
# 518 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
                                         ;
            }
        }
            ...
            if (p_port->p_data_callback || p_port->p_data_co_callback) {
                p_port->rx.peer_fc = 
# 525 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 3 4
                                    1
# 525 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
                                        ;
            }

            else if (fixed_queue_length(p_port->rx.queue) >= p_port->credit_rx_max) {
                p_port->rx.peer_fc = 
# 529 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 3 4
                                    1
# 529 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
                                        ;
            }
        }
    }
        ...
        if (enable) {
            ...
            if (p_port->rx.peer_fc
                    && (p_port->rx.queue_size < ((1691 -13 -(5 + 1)) * 4))
                    && (fixed_queue_length(p_port->rx.queue) < 4)) {
                p_port->rx.peer_fc = 
# 542 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 3 4
                                    0
# 542 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
                                         ;


                if (!p_port->rx.user_fc) {
                    RFCOMM_FlowReq (p_port->rfc.p_mcb, p_port->dlci, 
# 546 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 3 4
                                                                    1
# 546 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
                                                                        );
                }
            }
        }
            ...
            if (p_port->p_data_callback || p_port->p_data_co_callback) {
                p_port->rx.peer_fc = 
# 554 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 3 4
                                    1
# 554 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
                                        ;
                RFCOMM_FlowReq (p_port->rfc.p_mcb, p_port->dlci, 
# 555 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 3 4
                                                                0
# 555 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
                                                                     );
            }


            else if ( ((p_port->rx.queue_size > ((1691 -13 -(5 + 1)) * 10))
                      || (fixed_queue_length(p_port->rx.queue) > 10))
                      && !p_port->rx.peer_fc) {
                {if ((*rfc_cb_ptr).trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "PORT_DataInd Data reached HW. Sending FC set." "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM"); };};

                p_port->rx.peer_fc = 
# 564 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 3 4
                                    1
# 564 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
                                        ;
                RFCOMM_FlowReq (p_port->rfc.p_mcb, p_port->dlci, 
# 565 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c" 3 4
                                                                0
# 565 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/port_utils.c"
                                                                     );
            }
        }
    }
