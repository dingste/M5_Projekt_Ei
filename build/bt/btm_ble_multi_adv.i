# 1 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
# 1 "/home/dieter/Development/M5_Projekt_Ei/build/bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
# 19 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
...
# 20 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 2
...
# 22 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 2
...
# 23 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 2
...
# 27 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 2
...
# 28 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 2
...
# 29 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 2
# 52 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
...
# 74 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
void btm_ble_multi_adv_enq_op_q(UINT8 opcode, UINT8 inst_id, UINT8 cb_evt)
{
    tBTM_BLE_MULTI_ADV_OPQ *p_op_q = &(*btm_multi_adv_cb_ptr).op_q;
...
# 95 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
...
# 117 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
void btm_ble_multi_adv_vsc_cmpl_cback (tBTM_VSC_CMPL *p_params)
{
    ...
    if (len < 2) {
        {if ((*btm_cb_ptr).trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "wrong length for btm_ble_multi_adv_vsc_cmpl_cback" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        return;
    }
    ...
    {if ((*btm_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "op_code = %02x inst_id = %d cb_evt = %02x" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", opcode, inst_id, cb_evt); };};

    if (opcode != subcode || inst_id == 0) {
        {if ((*btm_cb_ptr).trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "get unexpected VSC cmpl, expect: %d get: %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", subcode, opcode); };};
        return;
    }

    p_inst = &(*btm_multi_adv_cb_ptr).p_adv_inst[inst_id - 1];

    switch (subcode) {
    case 0x05: {
        {if ((*btm_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_BLE_MULTI_ADV_ENB status = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", status); };};


        if (0x00 != status && 1 == cb_evt) {
            (*btm_multi_adv_cb_ptr).p_adv_inst[inst_id - 1].in_use = 
# 150 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                                             0
# 150 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                                                  ;
        }
        break;
    }
    ...
    case 0x01: {
        {if ((*btm_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_BLE_MULTI_ADV_SET_PARAM status = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", status); };};
        break;
    }

    case 0x02: {
        {if ((*btm_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_BLE_MULTI_ADV_WRITE_ADV_DATA status = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", status); };};
        break;
    }

    case 0x03: {
        {if ((*btm_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_BLE_MULTI_ADV_WRITE_SCAN_RSP_DATA status = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", status); };};
        break;
    }

    case 0x04: {
        {if ((*btm_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_BLE_MULTI_ADV_SET_RANDOM_ADDR status = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", status); };};
        break;
    }
...
# 179 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                         ((void *)0)
# 179 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                             ) {
        (p_inst->p_cback)(cb_evt, inst_id, p_inst->p_ref, status);
    }
    return;
}
# 197 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
tBTM_STATUS btm_ble_enable_multi_adv (BOOLEAN enable, UINT8 inst_id, UINT8 cb_evt)
{
    ...
    {if ((*btm_cb_ptr).trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " " btm_ble_enable_multi_adv: enb %d, Inst ID %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", enb, inst_id); };};

    if ((rt = BTM_VendorSpecificCommand (((0x3F << 10) | (0x02 <<7) | (0x01 << 0)),
                                         3,
                                         param,
...
# 232 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
static const int btm_ble_tx_power[7 + 1] = {-12, -9, -6, -3, 0, 3, 6, 9};
char btm_ble_map_adv_tx_power(int tx_power_index)
{
    if (0 <= tx_power_index && tx_power_index <= 7) {
        return (char)btm_ble_tx_power[tx_power_index];
    }
    return 0;
}
# 251 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
        ...
        UINT8 cb_evt)
{
    ...
    {if ((*btm_cb_ptr).trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " " btm_ble_multi_adv_set_params,Min %d, Max %d,adv_type %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_params->adv_int_min, p_params->adv_int_max, p_params->adv_type); };}
                                                                                      ;
    ...
    if (p_params->tx_power > 7) {
        p_params->tx_power = 7;
    }
    {*(pp)++ = (UINT8)(btm_ble_map_adv_tx_power(p_params->tx_power));};

    {if ((*btm_cb_ptr).trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "set_params:Chnl Map %d,adv_fltr policy %d,ID:%d, TX Power%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_params->channel_map, p_params->adv_filter_policy, p_inst->inst_id, p_params->tx_power); };}
                                                                                                            ;
...
# 377 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
void btm_ble_multi_adv_gen_rpa_cmpl(tBTM_RAND_ENC *p)
{
    ...
    UINT8 index = 0;
    tBTM_BLE_MULTI_ADV_INST *p_inst = 
# 382 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                     ((void *)0)
# 382 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                         ;


    if ((*btm_multi_adv_idx_q_ptr).front == -1) {
        {if ((*btm_cb_ptr).trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " " %s can't locate advertise instance" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", __FUNCTION__); };};
        return;
    } else {
        index = (*btm_multi_adv_idx_q_ptr).inst_index_queue[(*btm_multi_adv_idx_q_ptr).front];
        if ((*btm_multi_adv_idx_q_ptr).front == (*btm_multi_adv_idx_q_ptr).rear) {
            (*btm_multi_adv_idx_q_ptr).front = -1;
            (*btm_multi_adv_idx_q_ptr).rear = -1;
        } else {
            (*btm_multi_adv_idx_q_ptr).front = ((*btm_multi_adv_idx_q_ptr).front + 1) % 16;
        }
    }

    p_inst = &((*btm_multi_adv_cb_ptr).p_adv_inst[index]);

    {if ((*btm_cb_ptr).trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_multi_adv_gen_rpa_cmpl inst_id = %d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_inst->inst_id); };};
    if (p) {
        p->param_buf[2] &= (~0xc0);
        p->param_buf[2] |= 0x40;
        ...
        if (!SMP_Encrypt((*btm_cb_ptr).devcb.id_keys.irk, 16, p->param_buf, 3, &output)) {
            {if ((*btm_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "generate random address failed" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        } else {
...
# 438 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
void btm_ble_multi_adv_configure_rpa (tBTM_BLE_MULTI_ADV_INST *p_inst)
{
    if ((*btm_multi_adv_idx_q_ptr).front == ((*btm_multi_adv_idx_q_ptr).rear + 1) % 16) {
        {if ((*btm_cb_ptr).trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "outstanding rand generation exceeded max allowed " "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        return;
    } else {
        if ((*btm_multi_adv_idx_q_ptr).front == -1) {
            (*btm_multi_adv_idx_q_ptr).front = 0;
            (*btm_multi_adv_idx_q_ptr).rear = 0;
        } else {
            (*btm_multi_adv_idx_q_ptr).rear = ((*btm_multi_adv_idx_q_ptr).rear + 1) % 16;
        }
        (*btm_multi_adv_idx_q_ptr).inst_index_queue[(*btm_multi_adv_idx_q_ptr).rear] = p_inst->index;
    }
    btm_gen_resolvable_private_addr((void *)btm_ble_multi_adv_gen_rpa_cmpl);
}
# 466 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
void btm_ble_multi_adv_reenable(UINT8 inst_id)
{
    tBTM_BLE_MULTI_ADV_INST *p_inst = &(*btm_multi_adv_cb_ptr).p_adv_inst[inst_id - 1];

    if (
# 470 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
       1 
# 470 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
            == p_inst->in_use) {
        if (p_inst->adv_evt != 0x01) {
            btm_ble_enable_multi_adv (
# 472 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                     1
# 472 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                         , p_inst->inst_id, 0);
        } else

        {
            ...
            p_inst->in_use = 
# 477 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                            0
# 477 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                 ;
        }
    }
}
# 493 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
void btm_ble_multi_adv_enb_privacy(BOOLEAN enable)
{
    UINT8 i;
    tBTM_BLE_MULTI_ADV_INST *p_inst = &(*btm_multi_adv_cb_ptr).p_adv_inst[0];

    for (i = 0; i < BTM_BleMaxMultiAdvInstanceCount() - 1; i ++, p_inst++) {
        p_inst->in_use = 
# 499 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                        0
# 499 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
                             ;
        if (enable) {
...
# 523 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
tBTM_STATUS BTM_BleEnableAdvInstance (tBTM_BLE_ADV_PARAMS *p_params,
                                      tBTM_BLE_MULTI_ADV_CBACK *p_cback, void *p_ref)
{
    ...
    {if ((*btm_cb_ptr).trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_BleEnableAdvInstance called" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};

    if (0 == (*btm_cb_ptr).cmn_ble_vsc_cb.adv_inst_max) {
        {if ((*btm_cb_ptr).trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "Controller does not support Multi ADV" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        return BTM_ERR_PROCESSING;
    }

    if (
# 537 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
       ((void *)0) 
# 537 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
            == p_inst) {
        {if ((*btm_cb_ptr).trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "Invalid instance in BTM_BleEnableAdvInstance" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
        return BTM_ERR_PROCESSING;
    }

    for (i = 0; i < BTM_BleMaxMultiAdvInstanceCount() - 1; i ++, p_inst++) {
        if (
# 543 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
           0 
# 543 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
                 == p_inst->in_use) {
            p_inst->in_use = 
# 544 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                            1
# 544 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                ;
            ...
            {if ((*btm_cb_ptr).trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_enable_multi_adv being called with inst_id:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", p_inst->inst_id); };}
                                            ;

            if (BTM_CMD_STARTED == rt) {
                if ((rt = btm_ble_enable_multi_adv (
# 557 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                                   1
# 557 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                                       , p_inst->inst_id,
                                                    1)) == BTM_CMD_STARTED) {
            ...
            if (BTM_CMD_STARTED != rt) {
                p_inst->in_use = 
# 565 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                0
# 565 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                     ;
                {if ((*btm_cb_ptr).trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_BTM", "\033[0;" "31" "m" "E" " (%d) %s: " "BTM_BleEnableAdvInstance failed" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
            }
            break;
        }
    }
...
# 587 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
tBTM_STATUS BTM_BleUpdateAdvInstParam (UINT8 inst_id, tBTM_BLE_ADV_PARAMS *p_params)
{
    tBTM_STATUS rt = BTM_ILLEGAL_VALUE;
    tBTM_BLE_MULTI_ADV_INST *p_inst = &(*btm_multi_adv_cb_ptr).p_adv_inst[inst_id - 1];

    {if ((*btm_cb_ptr).trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_BleUpdateAdvInstParam called with inst_id:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", inst_id); };};
    ...
    if (inst_id < BTM_BleMaxMultiAdvInstanceCount() &&
            inst_id != 0 &&
            p_params != 
# 601 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                       ((void *)0)
# 601 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
                           ) {
        if (
# 602 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
           0 
# 602 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
                 == p_inst->in_use) {
            {if ((*btm_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "adv instance %d is not active" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", inst_id); };};
            return BTM_WRONG_MODE;
        } else {
            btm_ble_enable_multi_adv(
# 606 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                    0
# 606 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                         , inst_id, 0);
        }

        if (BTM_CMD_STARTED == btm_ble_multi_adv_set_params(p_inst, p_params, 0)) {
            rt = btm_ble_enable_multi_adv(
# 610 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                         1
# 610 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                             , inst_id, 3);
        }
    }
    return rt;
}
# 631 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
tBTM_STATUS BTM_BleCfgAdvInstData (UINT8 inst_id, BOOLEAN is_scan_rsp,
                                   tBTM_BLE_AD_MASK data_mask,
                                   tBTM_BLE_ADV_DATA *p_data)
{
    ...
    btm_ble_update_dmt_flag_bits(&p_data->flag, (*btm_cb_ptr).btm_inq_vars.connectable_mode,
                                 (*btm_cb_ptr).btm_inq_vars.discoverable_mode);

    {if ((*btm_cb_ptr).trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_BleCfgAdvInstData called with inst_id:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", inst_id); };};
...
# 686 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
tBTM_STATUS BTM_BleDisableAdvInstance (UINT8 inst_id)
{
    tBTM_STATUS rt = BTM_ILLEGAL_VALUE;
    tBTM_BLE_VSC_CB cmn_ble_vsc_cb;

    {if ((*btm_cb_ptr).trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "BTM_BleDisableAdvInstance with inst_id:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", inst_id); };};
    ...
    if (inst_id < BTM_BleMaxMultiAdvInstanceCount() &&
            inst_id != 0) {
        if ((rt = btm_ble_enable_multi_adv(
# 702 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                          0
# 702 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                               , inst_id, 2))
                == BTM_CMD_STARTED) {
            btm_ble_multi_adv_configure_rpa(&(*btm_multi_adv_cb_ptr).p_adv_inst[inst_id - 1]);
            btu_stop_timer_oneshot(&(*btm_multi_adv_cb_ptr).p_adv_inst[inst_id - 1].raddr_timer_ent);
            (*btm_multi_adv_cb_ptr).p_adv_inst[inst_id - 1].in_use = 
# 706 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                                             0
# 706 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                                                  ;
        }
    }
    return rt;
}
# 720 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
void btm_ble_multi_adv_vse_cback(UINT8 len, UINT8 *p)
{
    ...
    {if ((*btm_cb_ptr).trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_multi_adv_vse_cback called with event:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM", sub_event); };};
    if ((sub_event == 0x55) && (len >= 4)) {
        ...
        if ((idx = btm_handle_to_acl_index(conn_handle)) != 4) {
            ...
            if ((*btm_cb_ptr).ble_ctr_cb.privacy_mode != 0 &&
                ...
                memcpy((*btm_cb_ptr).acl_db[idx].conn_addr, (*btm_multi_adv_cb_ptr).p_adv_inst[adv_inst - 1].rpa,
                       6);
            }
        ...
        if (adv_inst < BTM_BleMaxMultiAdvInstanceCount() &&
                adv_inst != 0) {
            {if ((*btm_cb_ptr).trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_BTM", "D" " (%d) %s: " "btm_ble_multi_adv_reenable called" "\033[0m" "\n", esp_log_timestamp(), "BT_BTM"); };};
            btm_ble_multi_adv_reenable(adv_inst);
        }

        else if (adv_inst == 0) {
            if ((*btm_cb_ptr).ble_ctr_cb.inq_var.connectable_mode == 0x0100) {
                btm_ble_set_connectability ( (*btm_cb_ptr).ble_ctr_cb.inq_var.connectable_mode );
            }
        }
...
# 772 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
void btm_ble_multi_adv_init(void)
{

    btm_multi_adv_cb_ptr = (tBTM_BLE_MULTI_ADV_CB *)malloc((sizeof(tBTM_BLE_MULTI_ADV_CB)));
    btm_multi_adv_idx_q_ptr = (tBTM_BLE_MULTI_ADV_INST_IDX_Q *)malloc((sizeof(tBTM_BLE_MULTI_ADV_INST_IDX_Q)));
    if (btm_multi_adv_cb_ptr == 
# 777 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                               ((void *)0) 
# 777 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                    || btm_multi_adv_idx_q_ptr == 
# 777 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                                                  ((void *)0)
# 777 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                                                      ) {
    ...
    UINT8 i = 0;
    memset(&(*btm_multi_adv_cb_ptr), 0, sizeof(tBTM_BLE_MULTI_ADV_CB));
    memset (&(*btm_multi_adv_idx_q_ptr), 0, sizeof (tBTM_BLE_MULTI_ADV_INST_IDX_Q));
    (*btm_multi_adv_idx_q_ptr).front = -1;
    (*btm_multi_adv_idx_q_ptr).rear = -1;

    if ((*btm_cb_ptr).cmn_ble_vsc_cb.adv_inst_max > 0) {
        (*btm_multi_adv_cb_ptr).p_adv_inst = malloc((sizeof(tBTM_BLE_MULTI_ADV_INST) * ((*btm_cb_ptr).cmn_ble_vsc_cb.adv_inst_max)))
                                                                           ;
        memset((*btm_multi_adv_cb_ptr).p_adv_inst, 0, sizeof(tBTM_BLE_MULTI_ADV_INST) *
               ((*btm_cb_ptr).cmn_ble_vsc_cb.adv_inst_max));

        (*btm_multi_adv_cb_ptr).op_q.p_sub_code = malloc((sizeof(UINT8) * ((*btm_cb_ptr).cmn_ble_vsc_cb.adv_inst_max)))
                                                                                ;
        memset((*btm_multi_adv_cb_ptr).op_q.p_sub_code, 0,
               sizeof(UINT8) * ((*btm_cb_ptr).cmn_ble_vsc_cb.adv_inst_max));

        (*btm_multi_adv_cb_ptr).op_q.p_inst_id = malloc((sizeof(UINT8) * ((*btm_cb_ptr).cmn_ble_vsc_cb.adv_inst_max)))
                                                                               ;
        memset((*btm_multi_adv_cb_ptr).op_q.p_inst_id, 0,
               sizeof(UINT8) * ((*btm_cb_ptr).cmn_ble_vsc_cb.adv_inst_max));
    }


    for (i = 0; i < (*btm_cb_ptr).cmn_ble_vsc_cb.adv_inst_max; i++) {
        (*btm_multi_adv_cb_ptr).p_adv_inst[i].index = i;
        (*btm_multi_adv_cb_ptr).p_adv_inst[i].inst_id = i + 1;
    }

    BTM_RegisterForVSEvents(btm_ble_multi_adv_vse_cback, 
# 812 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                                        1
# 812 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                                            );
}
# 825 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
void btm_ble_multi_adv_cleanup(void)
{
    if ((*btm_multi_adv_cb_ptr).p_adv_inst) {
        free(((*btm_multi_adv_cb_ptr).p_adv_inst));
        (*btm_multi_adv_cb_ptr).p_adv_inst = 
# 829 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                     ((void *)0)
# 829 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                         ;
    }

    if ((*btm_multi_adv_cb_ptr).op_q.p_sub_code) {
        free(((*btm_multi_adv_cb_ptr).op_q.p_sub_code));
        (*btm_multi_adv_cb_ptr).op_q.p_sub_code = 
# 834 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                          ((void *)0)
# 834 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                              ;
    }

    if ((*btm_multi_adv_cb_ptr).op_q.p_inst_id) {
        free(((*btm_multi_adv_cb_ptr).op_q.p_inst_id));
        (*btm_multi_adv_cb_ptr).op_q.p_inst_id = 
# 839 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                         ((void *)0)
# 839 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                             ;
    }


    free((btm_multi_adv_cb_ptr));
    free((btm_multi_adv_idx_q_ptr));
    btm_multi_adv_cb_ptr = 
# 845 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                          ((void *)0)
# 845 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
                              ;
    btm_multi_adv_idx_q_ptr = 
# 846 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                             ((void *)0)
# 846 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                 ;

}
# 861 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
void *btm_ble_multi_adv_get_ref(UINT8 inst_id)
{
    tBTM_BLE_MULTI_ADV_INST *p_inst = 
# 863 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
                                     ((void *)0)
# 863 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
                                         ;

    if (inst_id < BTM_BleMaxMultiAdvInstanceCount()) {
        p_inst = &(*btm_multi_adv_cb_ptr).p_adv_inst[inst_id - 1];
        if (
# 867 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
           ((void *)0) 
# 867 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
                != p_inst) {
            return p_inst->p_ref;
        }
    }
    ...
    return 
# 872 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c" 3 4
          ((void *)0)
# 872 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/btm/btm_ble_multi_adv.c"
              ;
}
