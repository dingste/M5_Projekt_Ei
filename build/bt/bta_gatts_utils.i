# 1 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/gatt/bta_gatts_utils.c"
# 1 "/home/dieter/Development/M5_Projekt_Ei/build/bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/gatt/bta_gatts_utils.c"
# 25 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/gatt/bta_gatts_utils.c"
...
# 26 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/gatt/bta_gatts_utils.c" 2
...
# 30 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/gatt/bta_gatts_utils.c" 2
...
# 31 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/gatt/bta_gatts_utils.c" 2
...
# 32 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/gatt/bta_gatts_utils.c" 2
...
# 33 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/gatt/bta_gatts_utils.c" 2

static const UINT8 base_uuid[16] = {0xFB, 0x34, 0x9B, 0x5F, 0x80, 0x00, 0x00, 0x80,
                                               0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
                                              };
# 47 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/gatt/bta_gatts_utils.c"
...
# 64 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/gatt/bta_gatts_utils.c"
...
# 70 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/gatt/bta_gatts_utils.c" 3 4
                                     1
# 70 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/gatt/bta_gatts_utils.c"
                                         ;
...
# 87 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/gatt/bta_gatts_utils.c"
tBTA_GATTS_RCB *bta_gatts_find_app_rcb_by_app_if(tBTA_GATTS_IF server_if)
{
    UINT8 i;
    tBTA_GATTS_RCB *p_reg;

    for (i = 0, p_reg = (*bta_gatts_cb_ptr).rcb; i < 8; i ++, p_reg++) {
        if (p_reg->in_use && p_reg->gatt_if == server_if) {
            return p_reg;
        }
    }
    return 
# 97 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/gatt/bta_gatts_utils.c" 3 4
          ((void *)0)
# 97 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/gatt/bta_gatts_utils.c"
              ;
}
# 110 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/gatt/bta_gatts_utils.c"
...
# 130 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/gatt/bta_gatts_utils.c"
tBTA_GATTS_SRVC_CB *bta_gatts_find_srvc_cb_by_srvc_id(tBTA_GATTS_CB *p_cb, UINT16 service_id)
{
    UINT8 i;
    {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "bta_gatts_find_srvc_cb_by_srvc_id  service_id=%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", service_id); };};
    for (i = 0; i < 8; i ++) {
        if (p_cb->srvc_cb[i].in_use &&
                p_cb->srvc_cb[i].service_id == service_id) {
            {if (appl_trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_APPL", "D" " (%d) %s: " "bta_gatts_find_srvc_cb_by_srvc_id  found service cb index =%d" "\033[0m" "\n", esp_log_timestamp(), "BT_APPL", i); };};
            return &p_cb->srvc_cb[i];
        }
    }
    return 
# 141 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/gatt/bta_gatts_utils.c" 3 4
          ((void *)0)
# 141 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/gatt/bta_gatts_utils.c"
              ;
}
# 152 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/gatt/bta_gatts_utils.c"
tBTA_GATTS_SRVC_CB *bta_gatts_find_srvc_cb_by_attr_id(tBTA_GATTS_CB *p_cb, UINT16 attr_id)
{
    ...
    return 
# 175 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/gatt/bta_gatts_utils.c" 3 4
          ((void *)0)
# 175 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/gatt/bta_gatts_utils.c"
              ;
}
# 186 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/gatt/bta_gatts_utils.c"
BOOLEAN bta_gatts_uuid_compare(tBT_UUID tar, tBT_UUID src)
{
    ...
    if (src.len == 0 || tar.len == 0) {
        return 
# 193 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/gatt/bta_gatts_utils.c" 3 4
              1
# 193 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/gatt/bta_gatts_utils.c"
                  ;
    }
