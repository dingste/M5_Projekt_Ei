# 1 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
# 1 "/home/dieter/Development/M5_Projekt_Ei/build/bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
# 25 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
...
# 26 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c" 2
...
# 27 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c" 2
...
# 28 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c" 2
...
# 29 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c" 2
...
# 30 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c" 2
# 41 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_rm_register(tBTA_SYS_CONN_CBACK *p_cback)
{
    (*bta_sys_cb_ptr).prm_cb = p_cback;
}
# 57 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_policy_register(tBTA_SYS_CONN_CBACK *p_cback)
{
    (*bta_sys_cb_ptr).p_policy_cb = p_cback;
}
# 72 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_role_chg_register(tBTA_SYS_CONN_CBACK *p_cback)
{
    (*bta_sys_cb_ptr).p_role_cb = p_cback;
}
# 102 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_notify_role_chg(BD_ADDR_PTR p_bda, UINT8 new_role, UINT8 hci_status)
{
    if ((*bta_sys_cb_ptr).p_role_cb) {
        (*bta_sys_cb_ptr).p_role_cb(0x14, new_role, hci_status, p_bda);
    }
}
# 119 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_collision_register(UINT8 bta_id, tBTA_SYS_CONN_CBACK *p_cback)
{
    UINT8 index;

    for (index = 0; index < 5; index++) {
        if (((*bta_sys_cb_ptr).colli_reg.id[index] == bta_id) ||
                ((*bta_sys_cb_ptr).colli_reg.id[index] == 0)) {
            (*bta_sys_cb_ptr).colli_reg.id[index] = bta_id;
            (*bta_sys_cb_ptr).colli_reg.p_coll_cback[index] = p_cback;
            return;
        }
    }
}
# 143 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_notify_collision (BD_ADDR_PTR p_bda)
{
    UINT8 index;

    for (index = 0; index < 5; index++) {
        if (((*bta_sys_cb_ptr).colli_reg.id[index] != 0) &&
                ((*bta_sys_cb_ptr).colli_reg.p_coll_cback[index] != 
# 149 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c" 3 4
                                                            ((void *)0)
# 149 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
                                                                )) {
            (*bta_sys_cb_ptr).colli_reg.p_coll_cback[index] (0, 0, 0, p_bda);
        }
    }
}
# 165 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_sco_register(tBTA_SYS_CONN_CBACK *p_cback)
{
    (*bta_sys_cb_ptr).p_sco_cb = p_cback;
}
# 180 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_pm_register(tBTA_SYS_CONN_CBACK *p_cback)
{
    (*bta_sys_cb_ptr).ppm_cb = p_cback;
}
# 196 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_conn_open(UINT8 id, UINT8 app_id, BD_ADDR peer_addr)
{
    if ((*bta_sys_cb_ptr).prm_cb) {

        (*bta_sys_cb_ptr).prm_cb(0x00, id, app_id, peer_addr);

    }

    if ((*bta_sys_cb_ptr).ppm_cb) {

        (*bta_sys_cb_ptr).ppm_cb(0x00, id, app_id, peer_addr);

    }
}
# 224 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_conn_close(UINT8 id, UINT8 app_id, BD_ADDR peer_addr)
{
    if ((*bta_sys_cb_ptr).prm_cb) {

        (*bta_sys_cb_ptr).prm_cb(0x01, id, app_id, peer_addr);

    }

    if ((*bta_sys_cb_ptr).ppm_cb) {

        (*bta_sys_cb_ptr).ppm_cb(0x01, id, app_id, peer_addr);

    }
}
# 251 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_app_open(UINT8 id, UINT8 app_id, BD_ADDR peer_addr)
{
    if ((*bta_sys_cb_ptr).ppm_cb) {
        (*bta_sys_cb_ptr).ppm_cb(0x02, id, app_id, peer_addr);
    }
}
# 270 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_app_close(UINT8 id, UINT8 app_id, BD_ADDR peer_addr)
{
    if ((*bta_sys_cb_ptr).ppm_cb) {
        (*bta_sys_cb_ptr).ppm_cb(0x03, id, app_id, peer_addr);
    }
}
# 288 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_sco_open(UINT8 id, UINT8 app_id, BD_ADDR peer_addr)
{

    if ((id != 5) && ((*bta_sys_cb_ptr).p_sco_cb)) {

        (*bta_sys_cb_ptr).p_sco_cb(0x04, 1, app_id, peer_addr);
    }

    if ((*bta_sys_cb_ptr).ppm_cb) {
        (*bta_sys_cb_ptr).ppm_cb(0x04, id, app_id, peer_addr);
    }
}
# 311 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_sco_close(UINT8 id, UINT8 app_id, BD_ADDR peer_addr)
{
    ...
    if ((id != 5) && ((*bta_sys_cb_ptr).p_sco_cb)) {
        ...
        (*bta_sys_cb_ptr).p_sco_cb(0x05, num_sco_links, app_id, peer_addr);
    }

    if ((*bta_sys_cb_ptr).ppm_cb) {
        (*bta_sys_cb_ptr).ppm_cb(0x05, id, app_id, peer_addr);
    }
}
# 335 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_sco_use(UINT8 id, UINT8 app_id, BD_ADDR peer_addr)
{
    (void)(id);


    if ((*bta_sys_cb_ptr).p_sco_cb) {

        (*bta_sys_cb_ptr).p_sco_cb(0x04, 1, app_id, peer_addr);
    }
}
# 356 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
...
# 394 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_set_policy (UINT8 id, UINT8 policy, BD_ADDR peer_addr)
{
    if ((*bta_sys_cb_ptr).p_policy_cb) {
        (*bta_sys_cb_ptr).p_policy_cb(0x10, id, policy, peer_addr);
    }
}
# 411 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_clear_policy (UINT8 id, UINT8 policy, BD_ADDR peer_addr)
{
    if ((*bta_sys_cb_ptr).p_policy_cb) {
        (*bta_sys_cb_ptr).p_policy_cb(0x11, id, policy, peer_addr);
    }
}
# 428 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_set_default_policy (UINT8 id, UINT8 policy)
{
    if ((*bta_sys_cb_ptr).p_policy_cb) {
        (*bta_sys_cb_ptr).p_policy_cb(0x12, id, policy, 
# 431 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c" 3 4
                                                                ((void *)0)
# 431 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
                                                                    );
    }
}
# 445 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_clear_default_policy (UINT8 id, UINT8 policy)
{
    if ((*bta_sys_cb_ptr).p_policy_cb) {
        (*bta_sys_cb_ptr).p_policy_cb(0x13, id, policy, 
# 448 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c" 3 4
                                                                ((void *)0)
# 448 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
                                                                    );
    }
}
# 462 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_idle(UINT8 id, UINT8 app_id, BD_ADDR peer_addr)
{

    if ((*bta_sys_cb_ptr).prm_cb) {

        (*bta_sys_cb_ptr).prm_cb(0x06, id, app_id, peer_addr);

    }

    if ((*bta_sys_cb_ptr).ppm_cb) {

        (*bta_sys_cb_ptr).ppm_cb(0x06, id, app_id, peer_addr);
    }
}
# 487 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_busy(UINT8 id, UINT8 app_id, BD_ADDR peer_addr)
{
    if ((*bta_sys_cb_ptr).prm_cb) {

        (*bta_sys_cb_ptr).prm_cb(0x07, id, app_id, peer_addr);

    }

    if ((*bta_sys_cb_ptr).ppm_cb) {

        (*bta_sys_cb_ptr).ppm_cb(0x07, id, app_id, peer_addr);

    }
}
# 513 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_eir_register(tBTA_SYS_EIR_CBACK *p_cback)
{
    (*bta_sys_cb_ptr).eir_cb = p_cback;
}
# 528 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_add_uuid(UINT16 uuid16)
{
    if ((*bta_sys_cb_ptr).eir_cb) {
        (*bta_sys_cb_ptr).eir_cb(uuid16, 
# 531 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c" 3 4
                                 1 
# 531 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
                                      );
    }
}
# 545 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
void bta_sys_remove_uuid(UINT16 uuid16)
{
    if ((*bta_sys_cb_ptr).eir_cb) {
        (*bta_sys_cb_ptr).eir_cb(uuid16, 
# 548 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c" 3 4
                                 0
# 548 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
                                      );
    }
}
# 562 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
BOOLEAN bta_sys_vs_hdl(UINT16 evt, void *p)
{
    if ((*bta_sys_cb_ptr).p_vs_evt_hdlr) {
        return (*(*bta_sys_cb_ptr).p_vs_evt_hdlr)(evt, p);
    }

    return 
# 568 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c" 3 4
          0
# 568 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/bta/sys/bta_sys_conn.c"
               ;
}
