# 1 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c"
# 1 "/home/dieter/Development/M5_Projekt_Ei/build/bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c"
# 15 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c"
...
# 16 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c" 2
...
# 17 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c" 2
...
# 19 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c" 2
...
# 20 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c" 2
...
# 24 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c" 2
...
# 25 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c" 2
...
static esp_err_t ble_mesh_model_send_msg(esp_ble_mesh_model_t *model,
        ...
        uint16_t length, uint8_t *data,
        int32_t msg_timeout, 
# 33 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c" 3 4
                            _Bool 
# 33 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c"
                                 need_rsp,
        esp_ble_mesh_dev_role_t device_role)
{
    ...
    uint8_t *msg_data = 
# 38 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c" 3 4
                       ((void *)0)
# 38 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c"
                           ;
    btc_msg_t msg = {0};
    esp_err_t status;
    ...
    if (ctx && ctx->addr == 0x0000) {
        {if (3 >= ESP_LOG_ERROR) esp_log_write(ESP_LOG_ERROR, "BT_LOG", "\033[0;" "31" "m" "E" " (%d) %s: " "%s, Invalid destination address 0x0000" "\033[0m" "\n", esp_log_timestamp(), "BT_LOG", __func__); };
        return 0x102;
    }

    if (device_role > ROLE_FAST_PROV) {
        {if (3 >= ESP_LOG_ERROR) esp_log_write(ESP_LOG_ERROR, "BT_LOG", "\033[0;" "31" "m" "E" " (%d) %s: " "%s, Invalid device role 0x%02x" "\033[0m" "\n", esp_log_timestamp(), "BT_LOG", __func__, device_role); };
        return 0x102;
    }


    if (data == 
# 55 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c" 3 4
               ((void *)0)
# 55 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c"
                   ) {
        length = 0;
    }
    ...
    if (act == BTC_BLE_MESH_ACT_MODEL_PUBLISH) {
        if (op_len + length > model->pub->msg->size) {
            {if (3 >= ESP_LOG_ERROR) esp_log_write(ESP_LOG_ERROR, "BT_LOG", "\033[0;" "31" "m" "E" " (%d) %s: " "%s, Model publication msg size %d is too small" "\033[0m" "\n", esp_log_timestamp(), "BT_LOG", __func__, model->pub->msg->size); };
            return 0x102;
        }
    }
    ...
    if (op_len + length + mic_len > (((384) < (((60 - 3) * 12))) ? (384) : (((60 - 3) * 12)))) {
        {if (3 >= ESP_LOG_ERROR) esp_log_write(ESP_LOG_ERROR, "BT_LOG", "\033[0;" "31" "m" "E" " (%d) %s: " "%s, Data length %d is too large" "\033[0m" "\n", esp_log_timestamp(), "BT_LOG", __func__, length); };
        return 0x102;
    }
    ...
    if (act == BTC_BLE_MESH_ACT_MODEL_PUBLISH) {
        ...
        msg_data = (uint8_t *)malloc((op_len + length));
        if (msg_data == 
# 90 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c" 3 4
                       ((void *)0)
# 90 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c"
                           ) {
            return 0x101;
        }
...
esp_err_t esp_ble_mesh_register_custom_model_callback(esp_ble_mesh_model_cb_t callback)
{
    ...
    return (btc_profile_cb_set(BTC_PID_MODEL, callback) == 0 ? 0 : -1);
}
...
esp_err_t esp_ble_mesh_model_msg_opcode_init(uint8_t *data, uint32_t opcode)
{
    ...
    if (data == 
# 134 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c" 3 4
               ((void *)0)
# 134 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c"
                   ) {
        return 0x102;
    }
    ...
    if (opcode < 0x10000) {
        ...
        val = ((u16_t) ((((opcode) >> 8) & 0xff) | (((opcode) & 0xff) << 8)));
        memcpy(data, &val, 2);
        return 0;
    }
...
{
    if (model == 
# 161 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c" 3 4
                ((void *)0)
# 161 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c"
                    ) {
        return 0x102;
    }
        ...
        uint16_t length, uint8_t *data)
{
    ...
    return ble_mesh_model_send_msg(model, ctx, opcode, BTC_BLE_MESH_ACT_SERVER_MODEL_SEND,
                                   length, data, 0, 
# 175 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c" 3 4
                                                   0
# 175 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c"
                                                        , ROLE_NODE);
}
...
# 181 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c" 3 4
       _Bool 
# 181 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c"
            need_rsp, esp_ble_mesh_dev_role_t device_role)
{
    if (!model || !ctx) {
        return 0x102;
                                     ...
                                     esp_ble_mesh_dev_role_t device_role)
{
    ...
    return ble_mesh_model_send_msg(model, 
# 197 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c" 3 4
                                         ((void *)0)
# 197 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c"
                                             , opcode, BTC_BLE_MESH_ACT_MODEL_PUBLISH,
                                   length, data, 0, 
# 198 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c" 3 4
                                                   0
# 198 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c"
                                                        , device_role);
}
...
# 236 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c" 3 4
                                      ((void *)0)
# 236 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c"
                                          , 0, 
# 236 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c" 3 4
                                               ((void *)0)
# 236 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/api/core/esp_ble_mesh_networking_api.c"
