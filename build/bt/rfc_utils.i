# 1 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
# 1 "/home/dieter/Development/M5_Projekt_Ei/build/bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
# 25 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
...
# 26 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c" 2
...
# 28 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c" 2
...
# 29 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c" 2
...
# 31 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c" 2
...
# 32 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c" 2
...
# 33 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c" 2
...
# 34 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c" 2
...
# 35 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c" 2
...
# 38 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c" 2
...
# 39 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c" 2
...
# 41 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c" 2
# 50 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
...
# 84 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
...
# 109 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
BOOLEAN rfc_check_fcs (UINT16 len, UINT8 *p, UINT8 received_fcs)
{
    UINT8 fcs = 0xFF;
...
# 133 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
tRFC_MCB *rfc_alloc_multiplexer_channel (BD_ADDR bd_addr, BOOLEAN is_initiator)
{
    int i, j;
    tRFC_MCB *p_mcb = 
# 136 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c" 3 4
                     ((void *)0)
# 136 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
                         ;
    {if ((*rfc_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "rfc_alloc_multiplexer_channel: bd_addr:%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM", bd_addr[0], bd_addr[1], bd_addr[2], bd_addr[3], bd_addr[4], bd_addr[5]); };}
                                                                                              ;
    {if ((*rfc_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "rfc_alloc_multiplexer_channel:is_initiator:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM", is_initiator); };};

    for (i = 0; i < 4; i++) {
        {if ((*rfc_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "rfc_alloc_multiplexer_channel rfc_cb.port.rfc_mcb[%d].state:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM", i, (*rfc_cb_ptr).port.rfc_mcb[i].state); };}
                                                           ;
        {if ((*rfc_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "(rfc_cb.port.rfc_mcb[i].bd_addr:%02x:%02x:%02x:%02x:%02x:%02x" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM", (*rfc_cb_ptr).port.rfc_mcb[i].bd_addr[0], (*rfc_cb_ptr).port.rfc_mcb[i].bd_addr[1], (*rfc_cb_ptr).port.rfc_mcb[i].bd_addr[2], (*rfc_cb_ptr).port.rfc_mcb[i].bd_addr[3], (*rfc_cb_ptr).port.rfc_mcb[i].bd_addr[4], (*rfc_cb_ptr).port.rfc_mcb[i].bd_addr[5]); };}
        ...
        if (((*rfc_cb_ptr).port.rfc_mcb[i].state != 0)
            ...
            if ((*rfc_cb_ptr).port.rfc_mcb[i].state == 5) {
                rfc_timer_stop (&(*rfc_cb_ptr).port.rfc_mcb[i]);
            }
            {if ((*rfc_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "rfc_alloc_multiplexer_channel:is_initiator:%d, found, state:%d, p_mcb:%p" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM", is_initiator, (*rfc_cb_ptr).port.rfc_mcb[i].state, &(*rfc_cb_ptr).port.rfc_mcb[i]); };}
                                                                                                   ;
    ...
    for (i = 0, j = (*rfc_cb_ptr).rfc.last_mux + 1; i < 4; i++, j++) {
        if (j >= 4) {
            j = 0;
        }

        p_mcb = &(*rfc_cb_ptr).port.rfc_mcb[j];
        if ((*rfc_cb_ptr).port.rfc_mcb[j].state == 0) {

            fixed_queue_free(p_mcb->cmd_q, 
# 171 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c" 3 4
                                          ((void *)0)
# 171 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
                                              );
            rfc_timer_free(p_mcb);
            memset (p_mcb, 0, sizeof (tRFC_MCB));
            memcpy (p_mcb->bd_addr, bd_addr, 6);
            {if ((*rfc_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "rfc_alloc_multiplexer_channel:is_initiator:%d, create new p_mcb:%p, index:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM", is_initiator, &(*rfc_cb_ptr).port.rfc_mcb[j], j); };}
                                                                        ;

            p_mcb->cmd_q = fixed_queue_new(254);

            p_mcb->is_initiator = is_initiator;

            rfc_timer_start (p_mcb, 60);

            (*rfc_cb_ptr).rfc.last_mux = (UINT8) j;
            return (p_mcb);
        }
    }
    return (
# 188 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c" 3 4
           ((void *)0)
# 188 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
               );
}
...
# 202 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
...
# 221 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
void rfc_timer_start (tRFC_MCB *p_mcb, UINT16 timeout)
{
    TIMER_LIST_ENT *p_tle = &p_mcb->tle;

    {if ((*rfc_cb_ptr).trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "rfc_timer_start - timeout:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM", timeout); };};

    p_tle->param = (UINT32)p_mcb;

    btu_start_timer (p_tle, 11, timeout);
}
# 239 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
void rfc_timer_stop (tRFC_MCB *p_mcb)
{
    {if ((*rfc_cb_ptr).trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "rfc_timer_stop" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM"); };};

    btu_stop_timer (&p_mcb->tle);
}
# 253 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
void rfc_timer_free (tRFC_MCB *p_mcb)
{
    {if ((*rfc_cb_ptr).trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "rfc_timer_free" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM"); };};

    btu_free_timer (&p_mcb->tle);
    memset(&p_mcb->tle, 0, sizeof(TIMER_LIST_ENT));
}
# 268 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
void rfc_port_timer_start (tPORT *p_port, UINT16 timeout)
{
    TIMER_LIST_ENT *p_tle = &p_port->rfc.tle;

    {if ((*rfc_cb_ptr).trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "rfc_port_timer_start - timeout:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM", timeout); };};

    p_tle->param = (UINT32)p_port;

    btu_start_timer (p_tle, 12, timeout);
}
# 286 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
void rfc_port_timer_stop (tPORT *p_port)
{
    {if ((*rfc_cb_ptr).trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "rfc_port_timer_stop" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM"); };};

    btu_stop_timer (&p_port->rfc.tle);
}
# 300 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
...
# 318 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
void rfc_check_mcb_active (tRFC_MCB *p_mcb)
{
    ...
    for (i = 0; i < 61; i++) {
        if (p_mcb->port_inx[i] != 0) {
            p_mcb->is_disc_initiator = 
# 324 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c" 3 4
                                      0
# 324 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
                                           ;
            return;
        }
    }
    ...
    if (p_mcb->is_disc_initiator) {
        p_mcb->is_disc_initiator = 
# 331 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c" 3 4
                                  0
# 331 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
                                       ;
        rfc_mx_sm_execute (p_mcb, 8, 
# 332 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c" 3 4
                                                         ((void *)0)
# 332 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
                                                             );
    } else {
        rfc_timer_start (p_mcb, 2);
    }
}
# 348 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
void rfcomm_process_timeout (TIMER_LIST_ENT *p_tle)
{
    switch (p_tle->event) {
    case 11:
        rfc_mx_sm_execute ((tRFC_MCB *)p_tle->param, 5, 
# 352 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c" 3 4
                                                                       ((void *)0)
# 352 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
                                                                           );
        break;

    case 12:
        rfc_port_sm_execute ((tPORT *)p_tle->param, 5, 
# 356 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c" 3 4
                                                                      ((void *)0)
# 356 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
                                                                          );
        break;
...
# 375 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
void rfc_sec_check_complete (BD_ADDR bd_addr, tBT_TRANSPORT transport, void *p_ref_data, UINT8 res)
{
    ...
    rfc_port_sm_execute ((tPORT *)p_ref_data, 15, &res);
}
# 403 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
void rfc_port_closed (tPORT *p_port)
{
    tRFC_MCB *p_mcb = p_port->rfc.p_mcb;

    {if ((*rfc_cb_ptr).trace_level >= 5 && (((2) > (3) ? (2) : (3)) >= 5)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "rfc_port_closed" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM"); };};
...
# 436 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
void rfc_inc_credit (tPORT *p_port, UINT8 credit)
{
    if (p_port->rfc.p_mcb->flow == 2) {
        p_port->credit_tx += credit;

        {if ((*rfc_cb_ptr).trace_level >= 4 && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BT_RFCOMM", "D" " (%d) %s: " "rfc_inc_credit:%d" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM", p_port->credit_tx); };};

        if (p_port->tx.peer_fc == 
# 443 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c" 3 4
                                 1
# 443 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
                                     ) {
            PORT_FlowInd(p_port->rfc.p_mcb, p_port->dlci, 
# 444 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c" 3 4
                                                         1
# 444 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
                                                             );
        }
    }
}
# 460 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
void rfc_dec_credit (tPORT *p_port)
{
    if (p_port->rfc.p_mcb->flow == 2) {
        ...
        if (p_port->credit_tx == 0) {
            p_port->tx.peer_fc = 
# 468 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c" 3 4
                                1
# 468 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
                                    ;
        }
    }
}
# 484 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
void rfc_check_send_cmd(tRFC_MCB *p_mcb, BT_HDR *p_buf)
{
    ...
    if (p_buf != 
# 489 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c" 3 4
                ((void *)0)
# 489 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
                    ) {
        if (p_mcb->cmd_q == 
# 490 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c" 3 4
                           ((void *)0)
# 490 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
                               ) {
            {if ((*rfc_cb_ptr).trace_level >= 1 && (((2) > (3) ? (2) : (3)) >= 1)) {esp_log_write(ESP_LOG_ERROR, "BT_RFCOMM", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: empty queue: p_mcb = %p p_mcb->lcid = %u cached p_mcb = %p" "\033[0m" "\n", esp_log_timestamp(), "BT_RFCOMM", __func__, p_mcb, p_mcb->lcid, rfc_find_lcid_mcb(p_mcb->lcid)); };}

                                                              ;
        }
        fixed_queue_enqueue(p_mcb->cmd_q, p_buf, 0xffffffffUL);
    }


    while (p_mcb->l2cap_congested == 
# 499 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c" 3 4
                                    0
# 499 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
                                         ) {
        if ((p = (BT_HDR *)fixed_queue_dequeue(p_mcb->cmd_q, 0)) == 
# 500 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c" 3 4
                                                                   ((void *)0)
# 500 "/home/dieter/Development/esp-idf/components/bt/host/bluedroid/stack/rfcomm/rfc_utils.c"
                                                                       ) {
            break;
        }
