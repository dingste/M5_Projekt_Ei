# 1 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c"
# 1 "/home/dieter/Development/M5_Projekt_Ei/build/bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c"
# 10 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c"
...
# 11 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c" 2
# 1 "/home/dieter/Development/xtensa-esp32-elf/lib/gcc/xtensa-esp32-elf/8.2.0/include/stdbool.h" 1 3 4
# 12 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c" 2
...
# 13 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c" 2
...
# 15 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c" 2
...
# 18 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c" 2
...
# 19 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c" 2
...
# 20 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c" 2
# 1 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_common/include/mesh_trace.h" 1
# 21 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c" 2
...
# 22 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c" 2
...
# 23 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c" 2
...
struct bt_mesh_net;
# 25 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c" 2
...
# 26 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c" 2
                     ...
                     size_t sg_len, u8_t mac[16])
{
    ...
    if (tc_cmac_setup(&state, key, &sched) == 0) {
        return -
# 37 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c" 3 4
               5
# 37 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c"
                  ;
    }
    ...
    for (; sg_len; sg_len--, sg++) {
        if (tc_cmac_update(&state, sg->data,
                           sg->len) == 0) {
            return -
# 43 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c" 3 4
                   5
# 43 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c"
                      ;
        }
    }

    if (tc_cmac_final(mac, &state) == 0) {
        return -
# 48 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c" 3 4
               5
# 48 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c"
                  ;
    }
               ...
               u8_t net_id[1], u8_t enc_key[16], u8_t priv_key[16])
{
    ...
    do {if ((2 >= 4) && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BLE_MESH", "D" " (%d) %s: " "n %s" "\033[0m" "\n", esp_log_timestamp(), "BLE_MESH", bt_hex(n, 16)); };} while(0);
    do {if ((2 >= 4) && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BLE_MESH", "D" " (%d) %s: " "p %s" "\033[0m" "\n", esp_log_timestamp(), "BLE_MESH", bt_hex(p, p_len)); };} while(0);
    ...
    sg[0].data = 
# 92 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c" 3 4
                ((void *)0)
# 92 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c"
                    ;
    sg[0].len = 0;
    sg[1].data = p;
    sg[1].len = p_len;
    ...
    err = bt_mesh_aes_cmac(t, sg, ((unsigned long) (((int) sizeof(char[1 - 2 * !(!__builtin_types_compatible_p(__typeof__(sg), __typeof__(&(sg)[0])))]) - 1) + (sizeof(sg) / sizeof((sg)[0])))), out);
    if (err) {
        return err;
    }
    ...
    do {if ((2 >= 4) && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BLE_MESH", "D" " (%d) %s: " "NID 0x%02x enc_key %s" "\033[0m" "\n", esp_log_timestamp(), "BLE_MESH", net_id[0], bt_hex(enc_key, 16)); };} while(0);
    do {if ((2 >= 4) && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BLE_MESH", "D" " (%d) %s: " "priv_key %s" "\033[0m" "\n", esp_log_timestamp(), "BLE_MESH", bt_hex(priv_key, 16)); };} while(0);
                               ...
                               u8_t *out_msg, size_t mic_size)
{
    ...
    if (msg_len < 1 || aad_len >= 0xff00) {
        return -
# 211 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c" 3 4
               22
# 211 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c"
                     ;
    }
    ...
    if (memcmp(mic, enc_msg + msg_len, mic_size)) {
        return -
# 352 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c" 3 4
               77
# 352 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c"
                      ;
    }
                               ...
                               u8_t *out_msg, size_t mic_size)
{
    ...
    do {if ((2 >= 4) && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BLE_MESH", "D" " (%d) %s: " "key %s" "\033[0m" "\n", esp_log_timestamp(), "BLE_MESH", bt_hex(key, 16)); };} while(0);
    do {if ((2 >= 4) && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BLE_MESH", "D" " (%d) %s: " "nonce %s" "\033[0m" "\n", esp_log_timestamp(), "BLE_MESH", bt_hex(nonce, 13)); };} while(0);
    do {if ((2 >= 4) && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BLE_MESH", "D" " (%d) %s: " "msg (len %u) %s" "\033[0m" "\n", esp_log_timestamp(), "BLE_MESH", msg_len, bt_hex(msg, msg_len)); };} while(0);
    do {if ((2 >= 4) && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BLE_MESH", "D" " (%d) %s: " "aad_len %u mic_size %u" "\033[0m" "\n", esp_log_timestamp(), "BLE_MESH", aad_len, mic_size); };} while(0);


    if (aad_len >= 0xff00) {
        return -
# 375 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c" 3 4
               22
# 375 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c"
                     ;
    }
                          ...
                          const u8_t privacy_key[16])
{
    ...
    do {if ((2 >= 4) && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BLE_MESH", "D" " (%d) %s: " "IVIndex %u, PrivacyKey %s" "\033[0m" "\n", esp_log_timestamp(), "BLE_MESH", iv_index, bt_hex(privacy_key, 16)); };} while(0);

    sys_put_be32(iv_index, &priv_rand[5]);
    memcpy(&priv_rand[9], &pdu[7], 7);

    do {if ((2 >= 4) && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BLE_MESH", "D" " (%d) %s: " "PrivacyRandom %s" "\033[0m" "\n", esp_log_timestamp(), "BLE_MESH", bt_hex(priv_rand, 16)); };} while(0);
...
int bt_mesh_net_encrypt(const u8_t key[16], struct net_buf_simple *buf,
                        u32_t iv_index, 
# 599 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c" 3 4
                                       _Bool 
# 599 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c"
                                            proxy)
{
    u8_t mic_len = (((buf->data)[1] & 0x80) ? 8 : 4);
    u8_t nonce[13];
    int err;

    do {if ((2 >= 4) && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BLE_MESH", "D" " (%d) %s: " "IVIndex %u EncKey %s mic_len %u" "\033[0m" "\n", esp_log_timestamp(), "BLE_MESH", iv_index, bt_hex(key, 16), mic_len); };} while(0)
                   ;
    do {if ((2 >= 4) && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BLE_MESH", "D" " (%d) %s: " "PDU (len %u) %s" "\033[0m" "\n", esp_log_timestamp(), "BLE_MESH", buf->len, bt_hex(buf->data, buf->len)); };} while(0);
...
# 622 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c" 3 4
                             ((void *)0)
# 622 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c"
                                 , 0, &buf->data[7], mic_len);
    if (!err) {
...
int bt_mesh_net_decrypt(const u8_t key[16], struct net_buf_simple *buf,
                        u32_t iv_index, 
# 631 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c" 3 4
                                       _Bool 
# 631 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c"
                                            proxy)
{
    u8_t mic_len = (((buf->data)[1] & 0x80) ? 8 : 4);
    u8_t nonce[13];

    do {if ((2 >= 4) && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BLE_MESH", "D" " (%d) %s: " "PDU (%u bytes) %s" "\033[0m" "\n", esp_log_timestamp(), "BLE_MESH", buf->len, bt_hex(buf->data, buf->len)); };} while(0);
    do {if ((2 >= 4) && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BLE_MESH", "D" " (%d) %s: " "iv_index %u, key %s mic_len %u" "\033[0m" "\n", esp_log_timestamp(), "BLE_MESH", iv_index, bt_hex(key, 16), mic_len); };} while(0)
                   ;
...
# 655 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c" 3 4
                              ((void *)0)
# 655 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c"
                                  , 0, &buf->data[7], mic_len);
}

static void create_app_nonce(u8_t nonce[13], 
# 658 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c" 3 4
                                            _Bool 
# 658 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c"
                                                 dev_key, u8_t aszmic,
...
int bt_mesh_app_encrypt(const u8_t key[16], 
# 676 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c" 3 4
                                           _Bool 
# 676 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c"
                                                dev_key, u8_t aszmic,
                        struct net_buf_simple *buf, const u8_t *ad,
                        u16_t src, u16_t dst, u32_t seq_num, u32_t iv_index)
{
    ...
    do {if ((2 >= 4) && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BLE_MESH", "D" " (%d) %s: " "AppKey %s" "\033[0m" "\n", esp_log_timestamp(), "BLE_MESH", bt_hex(key, 16)); };} while(0);
    do {if ((2 >= 4) && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BLE_MESH", "D" " (%d) %s: " "dev_key %u src 0x%04x dst 0x%04x" "\033[0m" "\n", esp_log_timestamp(), "BLE_MESH", dev_key, src, dst); };} while(0);
    do {if ((2 >= 4) && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BLE_MESH", "D" " (%d) %s: " "seq_num 0x%08x iv_index 0x%08x" "\033[0m" "\n", esp_log_timestamp(), "BLE_MESH", seq_num, iv_index); };} while(0);
    do {if ((2 >= 4) && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BLE_MESH", "D" " (%d) %s: " "Clear: %s" "\033[0m" "\n", esp_log_timestamp(), "BLE_MESH", bt_hex(buf->data, buf->len)); };} while(0);
    ...
    err = bt_mesh_ccm_encrypt(key, nonce, buf->data, buf->len, ad,
                              ad ? 16 : 0, buf->data, ((aszmic) ? 8 : 4));
    if (!err) {
        net_buf_simple_add(buf, ((aszmic) ? 8 : 4));
        do {if ((2 >= 4) && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BLE_MESH", "D" " (%d) %s: " "Encr: %s" "\033[0m" "\n", esp_log_timestamp(), "BLE_MESH", bt_hex(buf->data, buf->len)); };} while(0);
    }
...
int bt_mesh_app_decrypt(const u8_t key[16], 
# 702 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c" 3 4
                                           _Bool 
# 702 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c"
                                                dev_key, u8_t aszmic,
                        struct net_buf_simple *buf, struct net_buf_simple *out,
                        const u8_t *ad, u16_t src, u16_t dst, u32_t seq_num,
                        u32_t iv_index)
{
    ...
    do {if ((2 >= 4) && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BLE_MESH", "D" " (%d) %s: " "EncData (len %u) %s" "\033[0m" "\n", esp_log_timestamp(), "BLE_MESH", buf->len, bt_hex(buf->data, buf->len)); };} while(0);
...
u8_t bt_mesh_fcs_calc(const u8_t *data, u8_t data_len)
{
    ...
    do {if ((2 >= 4) && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BLE_MESH", "D" " (%d) %s: " "fcs 0x%02x" "\033[0m" "\n", esp_log_timestamp(), "BLE_MESH", 0xff - fcs); };} while(0);

    return 0xff - fcs;
}


# 782 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c" 3 4
_Bool 
# 782 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c"
    bt_mesh_fcs_check(struct net_buf_simple *buf, u8_t received_fcs)
{
                      ...
                      const u8_t auth[16], u8_t conf[16])
{
    ...
    do {if ((2 >= 4) && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BLE_MESH", "D" " (%d) %s: " "ConfirmationKey %s" "\033[0m" "\n", esp_log_timestamp(), "BLE_MESH", bt_hex(conf_key, 16)); };} while(0);
    do {if ((2 >= 4) && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BLE_MESH", "D" " (%d) %s: " "RandomDevice %s" "\033[0m" "\n", esp_log_timestamp(), "BLE_MESH", bt_hex(rand, 16)); };} while(0);
    do {if ((2 >= 4) && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BLE_MESH", "D" " (%d) %s: " "AuthValue %s" "\033[0m" "\n", esp_log_timestamp(), "BLE_MESH", bt_hex(auth, 16)); };} while(0);

    return bt_mesh_aes_cmac(conf_key, sg, ((unsigned long) (((int) sizeof(char[1 - 2 * !(!__builtin_types_compatible_p(__typeof__(sg), __typeof__(&(sg)[0])))]) - 1) + (sizeof(sg) / sizeof((sg)[0])))), conf);
}

int bt_mesh_prov_decrypt(const u8_t key[16], u8_t nonce[13],
                         const u8_t data[25 + 8], u8_t out[25])
{
    return bt_mesh_ccm_decrypt(key, nonce, data, 25, 
# 844 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c" 3 4
                                                    ((void *)0)
# 844 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c"
                                                        , 0, out, 8);
}
# 855 "/home/dieter/Development/esp-idf/components/bt/esp_ble_mesh/mesh_core/crypto.c"
int bt_mesh_beacon_auth(const u8_t beacon_key[16], u8_t flags,
                        ...
                        u8_t auth[8])
{
    ...
    do {if ((2 >= 4) && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BLE_MESH", "D" " (%d) %s: " "BeaconKey %s" "\033[0m" "\n", esp_log_timestamp(), "BLE_MESH", bt_hex(beacon_key, 16)); };} while(0);
    do {if ((2 >= 4) && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BLE_MESH", "D" " (%d) %s: " "NetId %s" "\033[0m" "\n", esp_log_timestamp(), "BLE_MESH", bt_hex(net_id, 8)); };} while(0);
    do {if ((2 >= 4) && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BLE_MESH", "D" " (%d) %s: " "IV Index 0x%08x" "\033[0m" "\n", esp_log_timestamp(), "BLE_MESH", iv_index); };} while(0);

    msg[0] = flags;
    memcpy(&msg[1], net_id, 8);
    sys_put_be32(iv_index, &msg[9]);

    do {if ((2 >= 4) && (((2) > (3) ? (2) : (3)) >= 4)) {esp_log_write(ESP_LOG_DEBUG, "BLE_MESH", "D" " (%d) %s: " "BeaconMsg %s" "\033[0m" "\n", esp_log_timestamp(), "BLE_MESH", bt_hex(msg, sizeof(msg))); };} while(0);
